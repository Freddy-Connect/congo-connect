...
function SendTellFriend($iSenderID = 0)
{
	...
	// Freddy modif $sSenderName = strmaxtextlen(bx_get('sender_name'), 16);
	 $sSenderName = bx_get('sender_name');
	
	 // freddy ajout $sSenderAvatar = get_member_thumbnail($iSenderID, 'none', true);
	$sSenderAvatar = get_member_thumbnail($iSenderID, 'none', true);
    ...
    return sendMail($sRecipientEmail, $aTemplate['Subject'], $aTemplate['Body'], '', array(
		...
		// freddy ajout 'SenderAvatar' => $sSenderAvatar,
		'SenderAvatar' => $sSenderAvatar,
