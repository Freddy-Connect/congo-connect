...
<div class="adi_bd_sp">
	...
	<div class="adi_bb adi_mb3">
		<div class="adi_head1 adi_mb2">Upload Contacts File</div>
		<div class="adi_txt adi_mb3">CSV, VCF, LDIF, TXT</div>
	</div>

	<form action="" method="POST" class="adi_clt adi_nc_oauth_submit_form adi_nc_contact_file_form" enctype="multipart/form-data" target="adi_submit_contact_file">
	...
	<div class="adi_login_form_out adi_tal">
		...
		<div class="adi_login_field_out adi_mb4">
			<div class="adi_form_label adi_mb2 adi_tal">Select Contacts File :</div>
			<input type="file" name="adi_contact_file" style="width:210px;" class="adi_file_input adi_contact_file">
		</div>

		<div class="adi_login_btn_out adi_off_effect adi_mb1">
			<input class="adi_btn1" type="submit" name="adi_submit_conact_file" value="Import">
