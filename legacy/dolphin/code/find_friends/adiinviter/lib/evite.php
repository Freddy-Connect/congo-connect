...
class Adi_Service_evite extends AdiInviter_Pro_Core
{
    ...
    public function fetchContacts()
    {
        ...
        $this->get("https://www.evite.com/profile/contacts", true);
        ...
        $headers = ['Referer' => 'https://www.evite.com/profile/contacts'];
        $this->get('https://www.evite.com/ajax/profile/contacts/', $headers);
