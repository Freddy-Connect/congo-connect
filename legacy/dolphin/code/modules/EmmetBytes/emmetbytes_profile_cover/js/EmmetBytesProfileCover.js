...
EmmetBytesProfileCover.prototype.createProfileCoverForm = function(_formData){
   ...
   // freddy changemrnt var _save = $('<div>').addClass('ebytes_profile_cover_actions_button_container')
   var _save = $('<div>').addClass('freddy_bouton_save_profile_photo')
        .append($('<input/>').attr({'type' : 'submit'}).val('ENREGISTRER'))
        .click(function(){
            $this.clickedSubmitButton = 'Save';
        });
    // create the input for the cancel button
   // freddy changement var _cancel = $('<div>').addClass('ebytes_profile_cover_actions_button_container')
   var _cancel = $('<div>').addClass('freddy_bouton_save_profile_photo')
        .append($('<input/>').attr({'type' : 'submit'}).val('ANNULER'))
        .click(function(){
