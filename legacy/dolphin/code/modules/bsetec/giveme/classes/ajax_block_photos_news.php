...
<div class="browse_btn"><div class="<?php echo str_replace(' ', '_', $block);?> browse-section"><input type="file" name="bg_image[]" data-height="320" data-width="1400" data-id="<?php echo str_replace(' ', '_', $block);?>" onchange="document.getElementById('file-upload-text').innerHTML= this.value"></div></div>
