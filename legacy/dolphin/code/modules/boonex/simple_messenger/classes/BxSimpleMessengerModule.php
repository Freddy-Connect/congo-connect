 ...
 */
    ...
    class BxSimpleMessengerModule extends BxDolModule
    {
        ...
        {
           // Freddy ajout  global $oFunctions;
		   global $oFunctions;
            ...
            if ( $aMessages && is_array($aMessages) ) {
                foreach( $aMessages as $iKey => $aItems ) {
                    ...
                    //Freddy ajout
					'sender_icon'      => $oFunctions -> getMemberIcon($aMessages[$iKey]['SenderID'], 'none'),
        ...
        function getSimpleMessengerCore()
        {
            ...
            $sOutputCode  .=
            "
                 <audio hidden=\"hidden\" style=\"display:none;\" preload=\"auto\" id=\"aqb_beep_sound\"><source src=\"".BX_DOL_URL_ROOT."modules/boonex/simple_messenger/beep/beep.mp3\" type=\"audio/mpeg\"></audio>
        ...
        function serviceGetMessengerField($iViewedMemberId)
        {
		   ...
		   // Freddy ajout $iMemberId = (int) $iMemberId;
		   $iMemberId = (int) $iMemberId;
		    ...
		    if (!$this -> iLoggedMemberId || !get_user_online_status($iViewedMemberId)
			 ...
			 //$aProfilOwner = $this->oDb->getProfile($iMemberId);
			// freddy ajout
			// $aProfilOwner = getProfileInfo($iMemberId);
			 $aProfilOwnerChat = getNickName($aProfilOwner['ID']);
			 ////////////////////////////////////////////////
            ...
            if( $this -> isMessengerAlowed($iViewedMemberId)
                ...
                $aTemplateKeys = array (
                   ...
                   // freddy modif 'message'   => _t( '_simple_messenger_chat_now' )  . '...',
