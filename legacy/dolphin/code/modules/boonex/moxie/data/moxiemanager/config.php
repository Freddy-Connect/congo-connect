<?php
	...
	// General
	$moxieManagerConfig['general.license'] = 'IFYC-OGJG-AXJF-PCLM-IY7N-OG7A-5V2I-IBTJ';
	...
	$moxieManagerConfig['general.temp_dir'] = BX_DIRECTORY_PATH_ROOT . 'tmp';
	$moxieManagerConfig['general.http_proxy'] = '';
	$moxieManagerConfig['general.allow_override'] = 'hidden_tools,disabled_tools';

	// Filesystem
	$moxieManagerConfig['filesystem.rootpath'] = BX_DIRECTORY_PATH_ROOT . 'media/moxie/files';
	...
	$moxieManagerConfig['filesystem.extensions'] = 'jpg,jpeg,png,gif,webm,mp4,html,htm,txt,docx,doc,zip,pdf';
	...
	// Authentication
	$moxieManagerConfig['authenticator'] = 'DolphinAuthenticator';
	...
	$moxieManagerConfig['log.path'] = BX_DIRECTORY_PATH_ROOT . 'tmp';
	...
	// Cache
	$moxieManagerConfig['cache.connection'] = 'sqlite:' . BX_DIRECTORY_PATH_ROOT . 'media/moxie/storage/cache.s3db';

	// Storage
	$moxieManagerConfig['storage.engine'] = 'json';
	$moxieManagerConfig['storage.path'] = BX_DIRECTORY_PATH_ROOT . 'media/moxie/storage';
