...
if (BxDolRequest::serviceExists('aqb_conditional_fields', 'filter_view_data')) BxDolService::call('aqb_conditional_fields', 'filter_view_data', array(&$this->oPF->aBlocks, $ID));
//--- AQB Conditional Fields ---//
