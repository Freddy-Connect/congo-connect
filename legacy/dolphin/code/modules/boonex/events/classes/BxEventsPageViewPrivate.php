...
class BxEventsPageViewPrivate extends BxDolTwigPageView
{
    function BxEventsPageViewPrivate(&$oMain, &$aDataEntry)
    {   
		$this->_oMain = $oMain;

        parent::BxDolTwigPageView('bx_events_view', $oMain, $aDataEntry); 
    }
    ...
    function getBlockCode_Desc()
    {
		...
		$sMsg = ($isFanPending) ? '_bx_events_msg_private_join_pending' : '_bx_events_msg_private_join';
    ...
    function getBlockCode_Actions()
    {
		if(!$this->_oMain->_iProfileId)
			return array( MsgBox(_t('_bx_events_login', BX_DOL_URL_ROOT . 'member.php')) );
		...
		return $this->genObjectsActions($aInfo, 'bx_events'); 
    }
