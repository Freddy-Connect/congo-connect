...
class BxEventsSponsorFormAdd extends BxDolFormMedia {

    var $_oMain, $_oDb;

    function BxEventsSponsorFormAdd ($oMain, $iProfileId, $iEventId = 0, $iEntryId = 0, $iThumb = 0) { 
        $this->_oMain = $oMain;
        ...
        $aCustomForm = array(
            ...
            'inputs' => array(
	            ...
	            'address1' => array(
                    'type' => 'text',
                    'name' => 'address1',
                    'caption' => _t('_bx_events_form_caption_address1'),
                    'required' => true,
                    'checker' => array (
                        'func' => 'avail',
                        'error' => _t ('_bx_events_form_err_address1'),
                    ),
                    'db' => array (
                        'pass' => 'Xss', 
                    ),                
                ...
                'zip' => array(
                    'type' => 'text',
                    'name' => 'zip',
                    'caption' => _t('_bx_events_form_caption_zip'),
                    'required' => false, 
                    'db' => array (
                        'pass' => 'Xss', 
                    ),
                ...
                'header_contact' => array(
                    'type' => 'block_header',
                    'caption' => _t('_bx_events_form_header_contact')
                ),  
                'website' => array(
                    'type' => 'text',
                    'name' => 'website',
                    'caption' => _t('_bx_events_form_caption_website'),
                    'required' => false, 
                    'db' => array (
                        'pass' => 'Xss', 
                    ),
                ...
                'email' => array(
                    'type' => 'email',
                    'name' => 'email',
                    'caption' => _t('_bx_events_form_caption_email'),
                    'required' => false,  
					'db' => array (
                        'pass' => 'Xss', 
                    ),
                ...
                'telephone' => array(
                    'type' => 'text',
                    'name' => 'telephone',
                    'caption' => _t('_bx_events_form_caption_telephone'),
                    'required' => false, 
                    'db' => array (
                        'pass' => 'Xss', 
                    ),
                ...
                'fax' => array(
                    'type' => 'text',
                    'name' => 'fax',
                    'caption' => _t('_bx_events_form_caption_fax'),
                    'required' => false, 
                    'db' => array (
                        'pass' => 'Xss', 
                    ),
