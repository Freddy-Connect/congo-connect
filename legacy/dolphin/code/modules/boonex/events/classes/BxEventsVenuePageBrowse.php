...
class BxEventsVenuePageBrowse extends BxDolTwigPageMain {

    function BxEventsVenuePageBrowse(&$oMain, $sUri) {
        ...
        $this->sUrlStart = BX_DOL_URL_ROOT . $this->oConfig->getBaseUri() .  'venue/browse/' . $this->sUri;
		...
		parent::BxDolTwigPageMain('bx_events_venues_browse', $oMain);
	}
