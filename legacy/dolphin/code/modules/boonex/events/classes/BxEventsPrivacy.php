...
class BxEventsPrivacy extends BxDolPrivacy {
	 ...
	 * Constructor
	 */
    function BxEventsPrivacy(&$oModule , $sTable='main') {
        $this->oModule = $oModule;

		$iAuthorField = ($sTable=='main') ? 'ResponsibleID' : 'author_id';
		$iIdField = ($sTable=='main') ? 'ID' : 'id';
 
	    parent::BxDolPrivacy($oModule->_oDb->getPrefix() . $sTable, $iIdField, $iAuthorField);
    }
