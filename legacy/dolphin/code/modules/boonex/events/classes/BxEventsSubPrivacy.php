...
class BxEventsSubPrivacy extends BxDolPrivacy {
	 ...
	 * Constructor
	 */
    function BxEventsSubPrivacy(&$oModule, $sTable) {
	...
	/**
	 * Check whethere viewer is a member of dynamic Event.
	 *
	 * @param mixed $mixedId dynamic Event ID.
