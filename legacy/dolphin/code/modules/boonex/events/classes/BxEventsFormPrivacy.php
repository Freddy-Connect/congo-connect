...
class BxEventsFormPrivacy extends BxTemplFormView {

    function BxEventsFormPrivacy (&$oMain, $iId) {
        ...
        $aCustomForm = array(
            ...
            'inputs' => array(
                ...
                'header_privacy' => array(
                    'type' => 'block_header',
                    'caption' => _t('_bx_events_privacy_view_location'),
                ),

                'allow_view_location_to' => $oMain->_oPrivacy->getGroupChooser($iId, 'events', 'view_location'),
