...
class BxEventsSponsorPageBrowse extends BxDolTwigPageMain {

    function BxEventsSponsorPageBrowse(&$oMain, $sUri) {
        ...
        $this->sUrlStart = BX_DOL_URL_ROOT . $this->oConfig->getBaseUri() .  'sponsor/browse/' . $this->sUri;
		...
		parent::BxDolTwigPageMain('bx_events_sponsors_browse', $oMain);
	}
    ...
    function getBlockCode_Browse () {
        ...
        return $this->ajaxBrowseSubProfile(
            'sponsor',
            'sponsors',
            $this->oDb->getParam('bx_events_perpage_browse_subitems'), 
