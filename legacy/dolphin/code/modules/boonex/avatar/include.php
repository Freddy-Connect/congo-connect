...
if (!defined('BX_AVA_EXT')) {
    ...
    define ('BX_AVA_BROWSE_W', 128); // avatar browse width
    define ('BX_AVA_BROWSE_H', 128); // avatar browse height
   
   /* Freddy change pour augmenter la taille de la photo avatar
    define ('BX_AVA_W', 64); // avatar image width
    define ('BX_AVA_H', 64); // avatar image height
	*/
	
	define ('BX_AVA_W', 166); // avatar image width
    define ('BX_AVA_H', 166); // avatar image height
