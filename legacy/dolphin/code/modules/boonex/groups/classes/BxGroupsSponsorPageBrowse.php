...
class BxGroupsSponsorPageBrowse extends BxDolTwigPageMain {

    function BxGroupsSponsorPageBrowse(&$oMain, $sUri) {
		...
		parent::BxDolTwigPageMain('bx_groups_sponsors_browse', $oMain);
	}
    ...
    function getBlockCode_Browse () {
        ...
        return $this->ajaxBrowseSubProfile(
            'sponsor',
            'sponsors',
            $this->oDb->getParam('bx_groups_perpage_browse_subitems'), 
