...
class BxGroupsBlogPageBrowse extends BxDolTwigPageMain {

    function BxGroupsBlogPageBrowse(&$oMain, $sUri) {
		...
		parent::BxDolTwigPageMain('bx_groups_blogs_browse', $oMain);
	}
  
    function getBlockCode_Browse () {
 
        $this->sUrlStart = BX_DOL_URL_ROOT . $this->oConfig->getBaseUri() .  'blog/browse/' . $this->sUri . '?';
