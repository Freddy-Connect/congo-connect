...
class BxGroupsEventFormAdd extends BxDolFormMedia {

    var $_oMain, $_oDb;

    function BxGroupsEventFormAdd ($oMain, $iProfileId, $iEventId = 0, $iEntryId = 0, $iThumb = 0) { 
        $this->_oMain = $oMain;
        ...
        //$aCategories = $oProfileFields->convertValues4Input('#!GroupEventCategories');
 		//asort($aCategories);
...
*/
                ...
                'place' => array(
                    'type' => 'text',
                    'name' => 'place',
                    'caption' => _t('_bx_groups_caption_place'),
                    'required' => true,
                    'checker' => array (
                        'func' => 'avail',
                        'error' => _t ('_bx_groups_err_place'),
                    ),
                    'db' => array (
                        'pass' => 'Xss', 
                    ), 
                ...
                'city' => array(
                    'type' => 'text',
                    'name' => 'city',
                    'caption' => _t('_bx_groups_caption_city'),
                    'required' => true,
                    'checker' => array (
                        'func' => 'length',
                        'params' => array(3,50),
                        'error' => _t ('_bx_groups_err_city'),
                    ),
                    'db' => array (
                        'pass' => 'Xss', 
                    ),  
                ...
                'event_start' => array(
                    'type' => 'datetime',
                    'name' => 'event_start',
                    'caption' => _t('_bx_groups_caption_event_start'),
                    'required' => true,
                    'checker' => array (
                        'func' => 'DateTime',
                        'error' => _t ('_bx_groups_err_event_start'),
                    ),
                    'db' => array (
                        'pass' => 'DateTime', 
                    ),    
                ...
                'event_end' => array(
                    'type' => 'datetime',
                    'name' => 'event_end',
                    'caption' => _t('_bx_groups_caption_event_end'),
                    'required' => true,
                    'checker' => array (
                        'func' => 'DateTime',
                        'error' => _t ('_bx_groups_err_event_end'),
                    ),
                    'db' => array (
                        'pass' => 'DateTime', 
                    ),                    
