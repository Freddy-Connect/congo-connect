...
class BxGroupsVenueFormAdd extends BxDolFormMedia {

    var $_oMain, $_oDb;

    function BxGroupsVenueFormAdd ($oMain, $iProfileId, $iGroupId = 0, $iEntryId = 0, $iThumb = 0) { 
        $this->_oMain = $oMain;
        ...
        $aCustomForm = array(
            ...
            'inputs' => array(
	            ...
	            'address1' => array(
                    'type' => 'text',
                    'name' => 'address1',
                    'caption' => _t('_bx_groups_form_caption_address1'),
                    'required' => false, 
                    'db' => array (
                        'pass' => 'Xss', 
                    ),
