...
class BxGroupsVenuePageBrowse extends BxDolTwigPageMain {

    function BxGroupsVenuePageBrowse(&$oMain, $sUri) {
		...
		parent::BxDolTwigPageMain('bx_groups_venues_browse', $oMain);
	}
