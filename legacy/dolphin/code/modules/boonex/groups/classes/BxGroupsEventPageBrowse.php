...
class BxGroupsEventPageBrowse extends BxDolTwigPageMain {

    function BxGroupsEventPageBrowse(&$oMain, $sUri) {
		...
		parent::BxDolTwigPageMain('bx_groups_events_browse', $oMain);
	}
