...
class BxGroupsInstaller extends BxDolInstaller
{
    ...
    function install($aParams)
    {
		...
		BxDolService::call($this->_aConfig['home_uri'], 'sponsor_map_install');
		BxDolService::call($this->_aConfig['home_uri'], 'venue_map_install');
    ...
    function uninstall($aParams)
    {
        ...
        if ($aResult['result'] && BxDolModule::getInstance('BxWmapModule')){
            ...
            BxDolService::call('wmap', 'part_uninstall', array($this->_aConfig['home_uri'].'_sponsor'));
            BxDolService::call('wmap', 'part_uninstall', array($this->_aConfig['home_uri'].'_venue'));
		}
