...
$f->getUserPerm = 'getUserPermRoom';

function getUserPermRoom ($sUser, $sType, $sAction, $iForumId) {

    global $logged;

    $iMemberId = $logged['member'] ? $_COOKIE['memberID'] : 0;

    $aPerm = BxDolService::call('room', 'get_forum_permission', array ($iMemberId, $iForumId));
