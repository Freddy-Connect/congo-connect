...
$f->getUserPerm = 'getUserPermListing';
 
function getUserPermListing ($sUser, $sType, $sAction, $iForumId) {

    global $logged;

    $iMemberId = $logged['member'] ? $_COOKIE['memberID'] : 0;

    $aPerm = BxDolService::call('listing', 'get_forum_permission', array ($iMemberId, $iForumId));
