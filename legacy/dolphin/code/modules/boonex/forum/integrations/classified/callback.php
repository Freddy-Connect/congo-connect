...
$f->getUserPerm = 'getUserPermClassified';

 
function getUserPermClassified ($sUser, $sType, $sAction, $iForumId) {

    global $logged;

    $iMemberId = $logged['member'] ? $_COOKIE['memberID'] : 0;

    $aPerm = BxDolService::call('classified', 'get_forum_permission', array ($iMemberId, $iForumId));
