...
$f->getUserPerm = 'getUserPermJobs';


function getUserPermJobs ($sUser, $sType, $sAction, $iForumId) {

    global $logged;

    $iMemberId = $logged['member'] ? $_COOKIE['memberID'] : 0;

    $aPerm = BxDolService::call('jobs', 'get_forum_permission', array ($iMemberId, $iForumId));
