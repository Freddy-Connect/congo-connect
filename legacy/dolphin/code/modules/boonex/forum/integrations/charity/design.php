...
if (isset($_GET['action']) && 'goto' == $_GET['action'] && $_GET['forum_id']) {    
    ...
    $GLOBALS['oTopMenu']->setCustomVar('modzzz_charity_view_uri', $aForum['forum_uri']);
...
// do not show forum index page - always select Listing category at least 
