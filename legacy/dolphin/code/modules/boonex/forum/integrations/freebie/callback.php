...
$f->getUserPerm = 'getUserPermFreebie';

function getUserPermFreebie ($sUser, $sType, $sAction, $iForumId) {

    global $logged;

    $iMemberId = $logged['member'] ? $_COOKIE['memberID'] : 0;

    $aPerm = BxDolService::call('freebie', 'get_forum_permission', array ($iMemberId, $iForumId));
