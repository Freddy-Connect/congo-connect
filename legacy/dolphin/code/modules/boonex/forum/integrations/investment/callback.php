...
$f->getUserPerm = 'getUserPermInvestment';

 
function getUserPermInvestment ($sUser, $sType, $sAction, $iForumId) {

    global $logged;

    $iMemberId = $logged['member'] ? $_COOKIE['memberID'] : 0;

    $aPerm = BxDolService::call('investment', 'get_forum_permission', array ($iMemberId, $iForumId));
