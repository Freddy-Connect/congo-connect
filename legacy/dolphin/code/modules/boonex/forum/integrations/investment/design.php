...
if (isset($_GET['action']) && 'goto' == $_GET['action'] && $_GET['forum_id']) {    
    ...
    $GLOBALS['oTopMenu']->setCustomVar('modzzz_investment_view_uri', $aForum['forum_uri']);
...
// do not show forum index page - always select Investment category at least 

if (!isset($_GET['action']) && !isset($_POST['action'])) {
    $_GET['action'] = 'goto';
    $_GET['cat_id'] = 'Investment';
}
