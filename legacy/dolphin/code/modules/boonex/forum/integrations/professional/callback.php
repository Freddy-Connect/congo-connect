...
$f->getUserPerm = 'getUserPermProfessional';
 
function getUserPermProfessional ($sUser, $sType, $sAction, $iForumId) {

    global $logged;

    $iMemberId = $logged['member'] ? $_COOKIE['memberID'] : 0;

    $aPerm = BxDolService::call('professional', 'get_forum_permission', array ($iMemberId, $iForumId));
