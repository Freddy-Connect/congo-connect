...
class MbMmpTemplate extends BxDolTwigTemplate {
	...
	function availMemLevels()
	{
		...
		'mlevel_price' => $sPrice = ($aLevel['Free'] == '1') ? ' ' : '€'.'<span style=" font-weight:600; font-size:28px;">'.number_format($aPriceInfo['Price'],0, ',', '').'</span>'.' '.'/'.' '.'<span style=" font-weight:normal; ">'. _t('_dol_subs_year').'</span>',
