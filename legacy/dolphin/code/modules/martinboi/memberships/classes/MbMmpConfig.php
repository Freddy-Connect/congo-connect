...
class MbMmpConfig extends BxDolConfig {
	...
	function safe_pages(){
		$aSafe = array('_Home','_Log Out','_Unregister','_About','_TERMS_OF_USE_H','_PRIVACY_H','_help','_FAQ','_Contact','_dol_subs_mem_info','_Profile','_Account Home','_dol_subs_mem_info', '_dol_subs_title','_bx_ava_avatar','_modzzz_articles_menu_root');
		return $aSafe;
	}
	function safe_pages_guest(){
		$aSafeGuest = array('_Home','_Log Out','_Unregister','_bx_ava_avatar','_About','_TERMS_OF_USE_H','_PRIVACY_H','_help','_FAQ','_Contact','_Profile','_Account','_modzzz_articles_menu_root');
		return $aSafeGuest;
	}
	function getMonths(){
		$aMonths = array(
