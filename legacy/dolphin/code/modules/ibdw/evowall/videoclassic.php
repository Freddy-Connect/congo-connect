...
<div class="ibdw_evo_bt_list_choose" onclick="open_bt_list('x_evo_list');" id="fade_bt_listx_evo_list">
     ...
     <div class="ibdw_bt_superlist_swt" id="lista_btx_evo_list">
      <?php if($metvideotube == 'on' ) { echo '<a id="bottone_sub_elimina" href="javascript:lanciatube(\''.$namevideoalbum.'\');">'._t('_ibdw_evowall_uploadfromyoutube').'</a>'; } ?>
...
<div id="videoconthtml5">
<iframe name="upload_file_frame" style="display:none;"></iframe>
<script language="javascript" type="text/javascript" src="modules/boonex/videos/js/upload.js"></script>
...
<script>
	...
	<div style="display: none; margin: 10px; padding: 10px; border: 2px solid #f60; border-radius: 4px;" id="oooops"><?php echo _t('_sys_txt_uploader_html5_not_supported');?></div>
    ...
    <div class="b-button js-fileapi-wrapper bx-btn" id="buttons-panel">
        ...
        <input type="file" multiple="" accept="*" class="b-button__input" name="files">
    </div>
...
</div><form class="form_advanced" target="upload_file_frame" enctype="multipart/form-data" method="post" action="m/videos/albums/my/add_objects/<?php echo trim($$namevideoalbum); ?>/owner/<?php echo getUsername($_COOKIE['memberID']); ?>?action=accept_multi_html5" name="upload" id="video_upload_form"><input type="hidden" value="<?php echo trim($namevideoalbum);?>" name="extra_param_album" class="form_input_hidden bx-def-font-inputs"><input type="hidden" value="<?php echo $tokenfinale;?>" name="csrf_token" class="form_input_hidden bx-def-font-inputs"><div class="form_advanced_wrapper video_upload_form_wrapper">
	...
	<div class="bx-form-combined clearfix">
		<span class="bx-form-error"><i float_info=" " class="sys-icon exclamation-circle"></i></span><div class="input_wrapper input_wrapper_submit clearfix"><input type="submit" value="<?php echo _t('_bx_videos_submit');?>" name="submit_form" class="form_input_submit bx-btn"></div>
	</div>
</div></fieldset></div>
</div></form>
    </div>
				...
				_upload: function (file){
					if( file ) {
						...
						file.xhr = FileAPI.upload({
							url: 'm/videos/albums/my/add_objects/'+'<?php echo trim($namevideoalbum);?>'+'/owner/'+'<?php echo getUsername($_COOKIE['memberID']);?>'+'?action=accept_html5',
                            data: {"extra_param_album":"<?php echo trim($namevideoalbum);?>"},
							files: { file: file },
                            imageAutoOrientation: Boolean(0),
 ...
 <div style="background-color:#ffdada;" class="bx-def-margin-top" id="accepted_files_block"></div>
            ...
            <div style="display:none;" id="video_success_message"><div id="1443789828138" class="MsgBox">
    <table class="MsgBox bx-def-margin-top bx-def-margin-bottom"><tbody><tr><td>
        <div class="msgbox_content bx-def-font-large bx-def-padding-sec">
            <?php echo _t("_bx_videos_upl_succ");?>
        </div>
    </td></tr></tbody></table>
	
</div>
</div>
            <div style="display:none;" id="video_failed_file_message"><div id="1443789828615" class="MsgBox">
    <table class="MsgBox bx-def-margin-top bx-def-margin-bottom"><tbody><tr><td>
        <div class="msgbox_content bx-def-font-large bx-def-padding-sec">
            <?php echo _t("_bx_files_upl_err");?>
        </div>
    </td></tr></tbody></table>
	
</div>
</div>
            <div style="display:none;" id="video_failed_message"><div id="1443789828726" class="MsgBox">
    <table class="MsgBox bx-def-margin-top bx-def-margin-bottom"><tbody><tr><td>
        <div class="msgbox_content bx-def-font-large bx-def-padding-sec">
            <?php echo _t("_bx_videos_upl_err");?>
        </div>
    </td></tr></tbody></table>
	
</div>
</div>
            <div style="display:none;" id="video_embed_failed_message"><div id="144378982886" class="MsgBox">
    <table class="MsgBox bx-def-margin-top bx-def-margin-bottom"><tbody><tr><td>
        <div class="msgbox_content bx-def-font-large bx-def-padding-sec">
            <?php echo _t("_bx_videos_emb_err");?>
        </div>
    </td></tr></tbody></table>
