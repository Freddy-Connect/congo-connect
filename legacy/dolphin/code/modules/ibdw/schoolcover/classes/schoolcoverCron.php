...
bx_import('BxDolCron');
require_once('schoolcoverModule.php');
class schoolcoverCron extends BxDolCron 
{
 var $oModule;
 /*Class constructor;*/
 function schoolcoverCron() 
 {
  $this -> oModule = BxDolModule::getInstance('schoolcoverModule');
 }
 function processing() 
 {
