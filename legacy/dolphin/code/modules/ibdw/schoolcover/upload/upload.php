...
$verifica = "SELECT ID FROM ibdw_school_cover WHERE Owner = ".$userid." AND Uri='".$Uri."' LIMIT 1";
$exeverifica = mysql_query($verifica);
$num_rows = mysql_num_rows($exeverifica);
    
if($num_rows==0)
{ 
 $insequery = "INSERT INTO ibdw_school_cover (Owner,Hash,Uri) VALUES('".$userid."','".$hash."','".$Uri."')";
 $runquery = mysql_query($insequery);
}
else
{ 
