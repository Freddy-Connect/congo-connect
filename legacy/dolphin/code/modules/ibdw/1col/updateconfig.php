...
$listingurl = addslashes($_POST['listingurl']);
$addlistingurl = addslashes($_POST['addlistingurl']);
...
$jobsurl = addslashes($_POST['jobsurl']);
$addjobsurl = addslashes($_POST['addjobsurl']);
$classifiedurl = addslashes($_POST['classifiedurl']);
$fileurl = addslashes($_POST['fileurl']);
$addfileurl = addslashes($_POST['addfileurl']);
$addclassifiedurl = addslashes($_POST['addclassifiedurl']);
...
$inserimento="UPDATE 1col_config SET foto='".$photo."', video='".$video."', gruppi='".$group."', eventi='".$event."', siti='".$classified."', sondaggi='".$poll."', annunci='".$jobs."', blog='".$blog."', file='".$file."', suoni='".$sound."', pagine='".$listing."', emailad='".$emailad."', status='".$status."', city='".$city."', slide='".$slide."', numbermaxfriend='".$numbermaxfriend."', timereload='".$timereload."', mainmenuvar='".$mainmenuvar."', mediavar='".$mediavar."', acceditvar='".$acceditvar."', onlinefriendvar='".$onlinefriendvar."', deletebutton='".$deletebutton."', mailurl='".$mailurl."', addgroupurl='".$addgroupurl."', addlistingurl='".$addlistingurl."',eventurl='".$eventurl."', addeventurl='".$addeventurl."', pollurl='".$pollurl."', addpollurl='".$addpollurl."', jobsurl='".$jobsurl."', addjobsurl='".$addjobsurl."', classifiedurl='".$classifiedurl."', fileurl='".$fileurl."', addfileurl='".$addfileurl."', addclassifiedurl='".$addclassifiedurl."', photourl='".$photourl."', videourl='".$videourl."', soundurl='".$soundurl."', avatarurl='".$avatarurl."', groupurl='".$groupurl."', listingurl='".$listingurl."', avaset='".$avaset."', privasett='".$privasett."', sottoscrizione='".$sottoscrizione."', mailset='".$mailset."', blogurl='".$blogurl."', addblogurl='".$addblogurl."', customlink1 = '".$customlink_1."', customlink5='".$customlink_5."', customlink2='".$customlink_2."', customlink3='".$customlink_3."', customlink4='".$customlink_4."', customsectn='".$customsectn."', customsect1='".$customsect1."', customsect2='".$customsect2."', customsect3='".$customsect3."', customsect4='".$customsect4."', customsect5='".$customsect5."', amiciset='".$amiciset."'";
