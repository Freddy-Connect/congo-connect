  ...
  <div id="contentbox">
   ...
   <div class="spazio"></div>
	<form action="updateconfig.php" method="POST">
     ...
     <div class="unsesto">Listings</div><div class="unquarto"><input type="radio" name="listing" value="ON" <?php if($rowconfig['pagine']=='ON') {echo 'checked';}?>/>ON <input type="radio" name="listing" value="OFF" <?php if($rowconfig['pagine']=='OFF') {echo 'checked';}?>/>OFF</div>
	  
      <div class="unsesto">Jobs</div><div class="unquarto"><input type="radio" name="jobs" value="ON" <?php if($rowconfig['annunci']=='ON') {echo 'checked';}?>/>ON <input type="radio" name="jobs" value="OFF" <?php if($rowconfig['annunci']=='OFF') {echo 'checked';}?>/>OFF</div>
	 ...
	 <div class="contentcon">
	  ...
	  <div class="unsesto">Formations</div><div class="unquarto"><input type="radio" name="group" value="ON" <?php if($rowconfig['gruppi']=='ON') {echo 'checked';}?>/>ON <input type="radio" name="group" value="OFF" <?php if($rowconfig['gruppi']=='OFF') {echo 'checked';}?>/>OFF</div>
	 ...
	 <div class="contentcon">
	  ...
	  <div class="unsesto">Popularité</div><div class="unquarto"><input type="radio" name="poll" value="ON" <?php if($rowconfig['sondaggi']=='ON') {echo 'checked';}?>/>ON <input type="radio" name="poll" value="OFF" <?php if($rowconfig['sondaggi']=='OFF') {echo 'checked';}?>/>OFF</div>
    ...
    <div class="unsesto">Classifieds</div><div class="unquarto"><input type="radio" name="classified" value="ON" <?php if($rowconfig['siti']=='ON') {echo 'checked';}?> />ON <input type="radio" name="classified" value="OFF" <?php if($rowconfig['siti']=='OFF') {echo 'checked';}?>/>OFF</div>
	 	...
	 	<div class="contentcon">
	  <div class="unsesto">Investment</div><div class="unquarto"><input type="radio" name="file" value="ON" <?php if($rowconfig['file']=='ON') {echo 'checked';}?>/>ON <input type="radio" name="file" value="OFF" <?php if($rowconfig['file']=='OFF') {echo 'checked';}?>/>OFF</div>
	...
	<input type="radio" name="deletebutton" value="OFF" <?php if($rowconfig['deletebutton']=='OFF') {echo 'checked';}?>/>OFF
      <br/>
        ...
        <div class="conteineruri">
         ...
         <div class="ilinef"><div class="titolouri">Formations:</div><div class="inputright"><input type="text" name="groupurl" value="<?php echo $rowconfig['groupurl'];?>" size="26"></div></div>
         <div class="ilinef"><div class="titolouri">Add formation:</div><div class="inputright"><input type="text" name="addgroupurl" value="<?php echo $rowconfig['addgroupurl'];?>" size="26"></div></div>
         ...
         <div class="ilinef"><div class="titolouri">Popularité:</div><div class="inputright"><input type="text" name="pollurl" value="<?php echo $rowconfig['pollurl'];?>" size="26"></div></div>
         <div class="ilinef"><div class="titolouri">Add Popularité:</div><div class="inputright"><input type="text" name="addpollurl" value="<?php echo $rowconfig['addpollurl'];?>" size="26"></div></div>
         <div class="ilinef"><div class="titolouri">Jobs:</div><div class="inputright"><input type="text" name="jobsurl" value="<?php echo $rowconfig['jobsurl'];?>" size="26"></div></div>
         <div class="ilinef"><div class="titolouri">Add jobs:</div><div class="inputright"><input type="text" name="addjobsurl" value="<?php echo $rowconfig['addjobsurl'];?>" size="26"></div></div>
         <div class="ilinef"><div class="titolouri">Classified:</div><div class="inputright"><input type="text" name="classifiedurl" value="<?php echo $rowconfig['classifiedurl'];?>" size="26"></div></div>
         <div class="ilinef"><div class="titolouri">Add classified:</div><div class="inputright"><input type="text" name="addclassifiedurl" value="<?php echo $rowconfig['addclassifiedurl'];?>" size="26"></div></div>
         
         <div class="ilinef"><div class="titolouri">Investment:</div><div class="inputright"><input type="text" name="fileurl" value="<?php echo $rowconfig['fileurl'];?>" size="26"></div></div> 
         <div class="ilinef"><div class="titolouri">Add Investment:</div><div class="inputright"><input type="text" name="addfileurl" value="<?php echo $rowconfig['addfileurl'];?>" size="26"></div></div>
         
         
         <div class="ilinef"><div class="titolouri">Listings:</div><div class="inputright"><input type="text" name="listingurl" value="<?php echo $rowconfig['listingurl'];?>" size="26"></div></div>
         <div class="ilinef"><div class="titolouri">Add listing:</div><div class="inputright"><input type="text" name="addlistingurl" value="<?php echo $rowconfig['addlistingurl'];?>" size="26"></div></div>
