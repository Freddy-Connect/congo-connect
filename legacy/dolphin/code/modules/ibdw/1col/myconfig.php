...
$classifiedsvar=$riga['siti'];
$jobsvar=$riga['annunci'];
$evntvar=$riga['eventi'];
$groupsvar=$riga['gruppi'];
$listingsvar=$riga['pagine'];
...
$jobsurl = $riga['jobsurl'];            // AD URL
$addjobsurl = $riga['addjobsurl'];      // ADD AD URL
$blogurl = $riga['blogurl'];           // BLOG URL
$addblogurl = $riga['addblogurl'];     // ADD BLOG URL
$classifiedurl = $riga['classifiedurl'];          // SITE URL
$fileurl = $riga['fileurl'];          // FILE URL
$listingurl = $riga['listingurl'];          // PAGE URL
$addfileurl = $riga['addfileurl'];    // ADD FILE URL
$addlistingurl = $riga['addlistingurl'];    // ADD PAGE URL
$addclassifiedurl = $riga['addclassifiedurl'];    // ADD SITE URL
