            ...
            else
            {
              ...
              foreach($tags as $item)
              {
                foreach($item->attributes as $attrib)
                {
                  ...
                  $image_extension=isset($image_info['extension'])? $image_info['extension'] : '';
                  if($image_extension=='jpg' || $image_extension=='jpeg' || $image_extension=='png' )
                  {
                    $page->_values['image'] = $url;
                    $page->_values['image_src'] = $url;
                  }
                  if(isset($page->_values['image']) and $page->_values['image'] !="")
                  {
                    break;
                  }
