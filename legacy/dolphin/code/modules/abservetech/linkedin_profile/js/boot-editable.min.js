    ...
    e.fn.editableutils = {
        ...
        supportsTransitions: function() {
            ...
            for (var i = 0; i < r.length; i++)
                if (typeof t[r[i] + n] == "string") return !0;
            return !1
        }
    }
}(window.jQuery),
    ...
    t.prototype = {
        ...
        init: function(n, r) {
            this.$element = e(n), this.options = e.extend({}, e.fn.editableContainer.defaults, r), this.splitOptions(), this.formOptions.scope = this.$element[0], this.initContainer(), this.delayedHide = !1, this.$element.on("destroyed", e.proxy(function() {
                ...
                var r = e(n.target),
                    i, s = [".editable-container", ".ui-datepicker-header", ".datepicker", ".modal-backdrop", ".bootstrap-wysihtml5-insert-image-modal", ".bootstrap-wysihtml5-insert-link-modal"];
        ...
        container: function() {
            ...
            if (this.containerDataName)
                if (e = this.$element.data(this.containerDataName)) return e;
    ...
    e.fn.editableutils.inherit(t, e.fn.editabletypes.list), e.extend(t.prototype, {
        renderList: function() {
            ...
            var t = function(n, r) {
                var i;
                if (e.isArray(r))
                    for (var s = 0; s < r.length; s++) i = {}, r[s].children ? (i.label = r[s].text, n.append(t(e("<optgroup>", i), r[s].children))) : (i.value = r[s].value, r[s].disabled && (i.disabled = !0), n.append(e("<option>", i).text(r[s].text)));
                return n
            };
        ...
        fill: function() {
            ...
            while (p.valueOf() < v) {
                ...
                S === undefined ? S = {} : typeof S == "boolean" ? S = {
                    ...
                    classes: S
                }), S.enabled === !1 && g.push("disabled"), S.classes && (g = g.concat(S.classes.split(/\s+/))), S.tooltip && (l = S.tooltip), g = e.unique(g), m.push('<td class="' + g.join(" ") + '"' + (l ? ' title="' + l + '"' : "") + ">" + p.getUTCDate() + "</td>"), p.getUTCDay() == this.o.weekEnd && m.push("</tr>"), p.setUTCDate(p.getUTCDate() + 1)
            }
