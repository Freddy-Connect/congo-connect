...
class BxNotifyRequest extends BxDolRequest {

    function BxNotifyRequest() {
        parent::BxDolRequest();
    }
    ...
    function processAsAction($aModule, &$aRequest, $sClass = "Module") {
        ...
        $GLOBALS['oTopMenu']->setCustomSubActions($aVars, 'modzzz_Notify_title', false);

        return BxDolRequest::processAsAction($aModule, $aRequest, $sClass);
    }
}

BxNotifyRequest::processAsAction($GLOBALS['aModule'], $GLOBALS['aRequest']);