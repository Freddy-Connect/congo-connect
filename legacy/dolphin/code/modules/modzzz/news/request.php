...
class BxNewsRequest extends BxDolRequest {

    function BxNewsRequest() {
        parent::BxDolRequest();
    }
    ...
    function processAsAction($aModule, &$aRequest, $sClass = "Module") {
        ...
        $GLOBALS['oTopMenu']->setCustomSubActions($aVars, 'modzzz_news_title', false);

        return BxDolRequest::processAsAction($aModule, $aRequest, $sClass);
    }
}

BxNewsRequest::processAsAction($GLOBALS['aModule'], $GLOBALS['aRequest']);
