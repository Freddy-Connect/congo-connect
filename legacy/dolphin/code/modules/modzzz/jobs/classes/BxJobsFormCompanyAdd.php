...
class BxJobsFormCompanyAdd extends BxDolFormMedia {

    var $_oMain, $_oDb;

    function BxJobsFormCompanyAdd ($oMain, $iProfileId, $iEntryId = 0, $iThumb = 0) {
		...
		$sStateUrl = BX_DOL_URL_ROOT . $this->_oMain->_oConfig->getBaseUri() . 'home/'.(getParam('modzzz_jobs_permalinks') ? '?' : '&').'ajax=state&country=' ; 
        ...
        $aCustomForm = array(
            ...
            'inputs' => array(
                ...
                'header_company' => array(
                    'type' => 'block_header',
                    'caption' => _t('_modzzz_jobs_form_header_company_edit'),
                    'collapsable' => true,
                    'collapsed' => false,
                ),
                'company_name' => array(
                ...
                'company_country' => array(
                    ...
                    'checker' => array (
                        ...
                        'error' => _t ('_modzzz_jobs_err_country'),
                    ),      
 					'value' => $sSelCountry,
					'attrs' => array(
                ...
                'business_type' => array(
                    'type' => 'text',
                    'name' => 'business_type',
                    'caption' => _t('_modzzz_jobs_form_caption_business_type'),
                    'required' => false, 
                    'db' => array (
                        'pass' => 'Xss', 
                    ),
...
/*
                ...
                'allow_view_company_to' => $this->_oMain->_oPrivacy->getGroupChooser($iProfileId, 'jobs', 'view_job'),
