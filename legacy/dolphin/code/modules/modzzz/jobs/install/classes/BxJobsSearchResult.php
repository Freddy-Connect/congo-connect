...
class BxJobsSearchResult extends BxDolTwigSearchResult {
    ...
    var $aCurrent = array(
        ...
        'ownFields' => array('id', 'title', 'desc', 'uri', 'created', 'author_id', 'thumb', 'icon', 'rate',  'parent_category_id','category_id','company_id','company_type', 'role','vacancies','experience','qualification','skills','min_salary','max_salary','salary_type','currency','career_level','job_type','comments_count', 'tags','video_embed','membership_view_filter','post_type', 'currency', 'invoice_no','expiry_date', 'featured_expiry_date', 'country', 'city', 'state', 'address1', 'application_link'),
