...
class BxJobsFormPrivacy extends BxTemplFormView {

    function BxJobsFormPrivacy (&$oMain, $iId) {
        ...
        $aCustomForm = array(
            ...
            'inputs' => array(
                ...
                'header_privacy' => array(
                    'type' => 'block_header',
                    'caption' => _t('_modzzz_jobs_privacy_view_location'),
                ),

                'allow_view_location_to' => $oMain->_oPrivacy->getGroupChooser($iId, 'jobs', 'view_location'),
