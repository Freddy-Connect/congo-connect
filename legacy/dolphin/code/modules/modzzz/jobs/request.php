...
class BxJobsRequest extends BxDolRequest {

    function BxJobsRequest() {
        parent::BxDolRequest();
    }
    ...
    function processAsAction($aModule, &$aRequest, $sClass = "Module") {
        ...
        $GLOBALS['oTopMenu']->setCustomSubActions($aVars, 'modzzz_jobs_title', false);

        return BxDolRequest::processAsAction($aModule, $aRequest, $sClass);
    }
}

BxJobsRequest::processAsAction($GLOBALS['aModule'], $GLOBALS['aRequest']);