...
class BxCharityNewsPageBrowse extends BxDolTwigPageMain {

    function BxCharityNewsPageBrowse(&$oMain, $sUri) {
		...
		parent::BxDolTwigPageMain('modzzz_charity_news_browse', $oMain);
	}
