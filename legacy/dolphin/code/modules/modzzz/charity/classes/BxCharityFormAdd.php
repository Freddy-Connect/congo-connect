...
class BxCharityFormAdd extends BxDolFormMedia {

    var $_oMain, $_oDb;

    function BxCharityFormAdd ($oMain, $iProfileId, $iEntryId = 0, $iThumb = 0) {
       ...
       $this->_aMedia = array ();
        ...
        if (BxDolRequest::serviceExists('photos', 'perform_photo_upload', 'Uploader'))
            $this->_aMedia['images'] = array (
                ...
                'tag' => BX_CHARITY_PHOTOS_TAG,
                'cat' => BX_CHARITY_PHOTOS_CAT,
                'thumb' => 'thumb',
                'module' => 'photos',
                'title_upload_post' => 'images_titles',
                'title_upload' => _t('_modzzz_charity_form_caption_file_title'),
        ...
        if (BxDolRequest::serviceExists('videos', 'perform_video_upload', 'Uploader'))
            $this->_aMedia['videos'] = array (
                ...
                'tag' => BX_CHARITY_VIDEOS_TAG,
                'cat' => BX_CHARITY_VIDEOS_CAT,
                'thumb' => false,
                'module' => 'videos',
        ...
        if (BxDolRequest::serviceExists('sounds', 'perform_music_upload', 'Uploader'))
            $this->_aMedia['sounds'] = array (
                ...
                'tag' => BX_CHARITY_SOUNDS_TAG,
                'cat' => BX_CHARITY_SOUNDS_CAT,
                'thumb' => false,
                'module' => 'sounds',
        ...
        if (BxDolRequest::serviceExists('files', 'perform_file_upload', 'Uploader'))
            $this->_aMedia['files'] = array (
                ...
                'tag' => BX_CHARITY_FILES_TAG,
                'cat' => BX_CHARITY_FILES_CAT,
                'thumb' => false,
                'module' => 'files',
		...
		$aYesNo = array(
						1=>_t('_modzzz_charity_yes'),
						0=>_t('_modzzz_charity_no'),
					);
		...
		$alegal_statusList = $oProfileFields->convertValues4Input('#!CharityLegalStatus');
        ksort($alegal_statusList);
        ...
        $aInputPrivacyCustom[] = array ('key' => 'f', 'value' => _t('_modzzz_charity_privacy_fans_only'));
        ...
        $aInputPrivacyCustom2 = array (
            array('key' => 'f', 'value' => _t('_modzzz_charity_privacy_fans')),
            array('key' => 'a', 'value' => _t('_modzzz_charity_privacy_admins_only'))
        );
        ...
        $aInputPrivacyViewFans = $this->_oMain->_oPrivacy->getGroupChooser($iProfileId, 'charity', 'view_fans');
        $aInputPrivacyViewFans['values'] = array_merge($aInputPrivacyViewFans['values'], $aInputPrivacyCustom);

		$aInputPrivacyDonors = $this->_oMain->_oPrivacy->getGroupChooser($iProfileId, 'charity', 'view_donors');
		...
		$aInputPrivacyComment = $this->_oMain->_oPrivacy->getGroupChooser($iProfileId, 'charity', 'comment');
        ...
        $aInputPrivacyRate = $this->_oMain->_oPrivacy->getGroupChooser($iProfileId, 'charity', 'rate');
        ...
        $aInputPrivacyForum = $this->_oMain->_oPrivacy->getGroupChooser($iProfileId, 'charity', 'post_in_forum');
        ...
        $aInputPrivacyUploadPhotos = $this->_oMain->_oPrivacy->getGroupChooser($iProfileId, 'charity', 'upload_photos');
        $aInputPrivacyUploadPhotos['values'] = $aInputPrivacyCustom2;
        $aInputPrivacyUploadPhotos['db'] = $aInputPrivacyCustom2Pass;

        $aInputPrivacyUploadVideos = $this->_oMain->_oPrivacy->getGroupChooser($iProfileId, 'charity', 'upload_videos');
        $aInputPrivacyUploadVideos['values'] = $aInputPrivacyCustom2;
        $aInputPrivacyUploadVideos['db'] = $aInputPrivacyCustom2Pass;        

        $aInputPrivacyUploadSounds = $this->_oMain->_oPrivacy->getGroupChooser($iProfileId, 'charity', 'upload_sounds');
        $aInputPrivacyUploadSounds['values'] = $aInputPrivacyCustom2;
        $aInputPrivacyUploadSounds['db'] = $aInputPrivacyCustom2Pass;

        $aInputPrivacyUploadFiles = $this->_oMain->_oPrivacy->getGroupChooser($iProfileId, 'charity', 'upload_files');
        ...
        $aCustomForm = array(
            ...
            'inputs' => array(
                ...
                'header_info' => array(
                    'type' => 'block_header',
                    'caption' => _t('_modzzz_charity_form_header_info')
                ),                
 
                'title' => array(
                    'type' => 'text',
                    'name' => 'title',
                    'caption' => _t('_modzzz_charity_form_caption_charity_name'),
                    'value' => $sDefaultTitle,  
                    'required' => true,
                    'checker' => array (
                        'func' => 'length',
                        'params' => array(2,200),
                        'error' => _t ('_modzzz_charity_form_err_title'),
                    ),
                    'db' => array (
                        'pass' => 'Xss', 
                    ),
				...
				// fax : champ abbreviation
				 'businessfax' => array(
                    'type' => 'text',
                    'name' => 'businessfax',
                    'caption' => _t('_modzzz_charity_form_caption_businessfax'),
                    'required' => false, 
                    'db' => array (
                        'pass' => 'Xss', 
                    ),
				...
				/* 'legal_status' => array(
                    'type' => 'select',
                    'name' => 'legal_status',
                    'listname' => 'CharityLegalStatus',
					'values'=> $alegal_statusList,
                    'caption' => _t('_modzzz_charity_form_caption_legal_status'), 
					
					
                     'required' => true,
                    'checker' => array (
                        'func' => 'avail',
                        'error' => _t ('_modzzz_charity_form_err_legal_status'),
                    ),
                    'db' => array (
                        'pass' => 'Int', 
                    ),
                ...
                'businessname' => array(
                    'type' => 'text',
                    'name' => 'businessname',
                    'caption' => _t('_modzzz_charity_form_caption_businessname'),
                    'required' => false, 
                    'db' => array (
                        'pass' => 'Xss', 
                    ),
				...
				*/
				...
				'header_contact' => array(
                    'type' => 'block_header',
                    'caption' => _t('_modzzz_charity_form_header_contact')
                ), 
                ...
                'businessemail' => array(
                    'type' => 'email',
                    'name' => 'businessemail',
                    'caption' => _t('_modzzz_charity_form_caption_businessemail'),
                    'required' => true,
                    'checker' => array (
                        'func' => 'avail',
                        'error' => _t ('_modzzz_charity_form_err_businessemail'),
                    ), 
					'db' => array (
                        'pass' => 'Xss', 
                    ),
                ...
                'businesstelephone' => array(
                    ...
                    'caption' => _t('_modzzz_charity_form_caption_businesstelephone'),
                      'required' => true,
					 'checker' => array (
                        'func' => 'avail',
                        'error' => _t ('_modzzz_charity_form_err_businesstelephone'),
                    ), 
                    'db' => array (
                        'pass' => 'Xss', 
                    ),
			  ...
			  'businesswebsite' => array(
                    ...
                    'caption' => _t('_modzzz_charity_form_caption_businesswebsite'),
                    'required' => false, 
                    'db' => array (
                        'pass' => 'Xss', 
                    ),
				 ...
				 'header_location' => array(
                    'type' => 'block_header',
                    'caption' => _t('_modzzz_charity_form_header_headquarters')
                ),
				...
				'country' => array(
                    ...
                    'values' => $aCountries,
 					'value' => $sSelCountry,
					'attrs' => array(
						'onchange' => "getHtmlData('s
						
						ubstate','$sStateUrl'+this.value)",
					),
					'required' => true, 	 
                    'checker' => array (
                        'func' => 'avail',
                        'error' => _t ('_modzzz_charity_form_err_country'),
                    ), 
                    'db' => array (
                        'pass' => 'Preg', 
				 ...
				 'address1' => array(
                    'type' => 'text',
                    'name' => 'address1',
                    'caption' => _t('_modzzz_charity_form_caption_address1'),
                    'required' => true, 
					 'checker' => array (
                        'func' => 'avail',
                        'error' => _t ('_modzzz_charity_form_err_address1'),
                    ), 
                    'db' => array (
                        'pass' => 'Xss', 
                    ),
				...
				'state' => array(
                   ...
                   'checker' => array (
                        'func' => 'avail',
                        'error' => _t ('_modzzz_charity_caption_err_state'),
                    ),   
					'db' => array (
					'pass' => 'Preg', 
                ...
                'city' => array(
					...
					'checker' => array (
                        'func' => 'avail',
                        'error' => _t ('_modzzz_charity_form_err_city'),
                    ),  
                    'db' => array (
                        'pass' => 'Xss', 
                    ),
                ...
                'zip' => array(
                    'type' => 'text',
                    'name' => 'zip',
                    'caption' => _t('_modzzz_charity_form_caption_zip'),
                    'required' => false,
					/*
					 'checker' => array (
                        'func' => 'avail',
                        'error' => _t ('_modzzz_charity_form_err_zip'),
                    ),  
					*/
                    'db' => array (
                        'pass' => 'Xss', 
              ...
              /*
			    'address2' => array(
                    'type' => 'text',
                    'name' => 'address2',
                    'caption' => _t('_modzzz_charity_form_caption_address2'),
                    'required' => false, 
                    'db' => array (
                        'pass' => 'Xss', 
                    ),
				...
				*/
				...
				/*
				 'header_area_operation' => array(
                    'type' => 'block_header',
                    'caption' => _t('_modzzz_charity_form_area_of_operation')
                ),
				*/
				...
				*/
                ...
                'desc' => array(
                    'type' => 'textarea',
                    'name' => 'desc',
                    'caption' => _t('_modzzz_charity_form_caption_about_us'),
                    'required' => true,
                    'html' => 1,
                    'checker' => array (
                        'func' => 'length',
                        'params' => array(5,64000),
                        'error' => _t ('_modzzz_charity_form_err_desc'),
                    ),                    
                    'db' => array (
                        'pass' => 'XssHtml', 
                    ),                    
               ...
               /*
			    'believe' => array(
                    'type' => 'textarea',
                    'name' => 'believe',
                    'caption' => _t('_modzzz_charity_form_caption_believe'),
                    'required' => false,
                    'html' => 1, 
                    'db' => array (
                        'pass' => 'XssHtml', 
                ...
                'history' => array(
                    'type' => 'textarea',
                    'name' => 'history',
                    'caption' => _t('_modzzz_charity_form_caption_history'),
                    'required' => false,
                    'html' => 1, 
                    'db' => array (
                        'pass' => 'XssHtml', 
                ...
                'tags' => array(
                    ...
                    'checker' => array (
                        'func' => 'avail',
                        'error' => _t ('_modzzz_charity_form_err_tags'),
                    ),
                    'db' => array (
                        'pass' => 'Tags', 
                    ),
				...
				*/ 
			    ...
			    'categories' => $oCategories->getGroupChooser ('modzzz_charity', (int)$iProfileId, true), 

              /*
			    'paypal' => array(
                    'type' => 'text',
                    'name' => 'paypal',
                    'caption' => _t('_modzzz_charity_form_caption_paypal'),
                    'info' => _t('_modzzz_charity_form_info_paypal'),
                    'required' => false, 
                    'db' => array (
                        'pass' => 'Xss', 
                    ) 
				...
				*/
                ...
                'header_images' => array(
                    'type' => 'block_header',
                    'caption' => _t('_modzzz_charity_form_header_images'),
                    'collapsable' => true,
                    'collapsed' => false,
                ),
                'thumb' => array(
                    ...
                    'name' => 'thumb',
                    'caption' => _t('_modzzz_charity_form_caption_thumb_choice'),
                    'info' => _t('_modzzz_charity_form_info_thumb_choice'),
                    'required' => false,
                    'db' => array (
                        'pass' => 'Int',
                    ),
                ...
                'images_choice' => array(
                    ...
                    'name' => 'images_choice[]',
                    'caption' => _t('_modzzz_charity_form_caption_images_choice'),
                    'info' => _t('_modzzz_charity_form_info_images_choice'),
                    'required' => false,
                ),  
                'images_upload' => array(
                    'type' => 'custom',
                    ...
                    'name' => 'images_upload[]',
                    'caption' => _t('_modzzz_charity_form_caption_images_upload'),
                    'info' => _t('_modzzz_charity_form_info_images_upload'),
                    'required' => false,
                ),
				...
				'header_video_embed' => array(
					'type' => 'block_header',
					'caption' => _t('_modzzz_charity_form_header_video_embed'),
					'collapsable' => true,
					'collapsed' => false,
				),
				*/
				'video_embed' => array(
					'type' => 'text',
					'name' => 'video_embed',
					'caption' => _t('_modzzz_charity_caption_video_embed_code'),
					'info' => _t('_modzzz_charity_form_info_video_embed_code'),
				...
				'header_videos' => array(
                    'type' => 'block_header',
                    'caption' => _t('_modzzz_charity_form_header_videos'),
                    'collapsable' => true,
                    'collapsed' => false,
                ),
                ...
                'videos_choice' => array(
                    ...
                    'name' => 'videos_choice[]',
                    'caption' => _t('_modzzz_charity_form_caption_videos_choice'),
                    'info' => _t('_modzzz_charity_form_info_videos_choice'),
                    'required' => false,
                ),
                ...
                'videos_upload' => array(
                    ...
                    'name' => 'videos_upload[]',
                    'caption' => _t('_modzzz_charity_form_caption_videos_upload'),
                    'info' => _t('_modzzz_charity_form_info_videos_upload'),
                    'required' => false,
                ),
				/* 
                ...
                'header_sounds' => array(
                    'type' => 'block_header',
                    'caption' => _t('_modzzz_charity_form_header_sounds'),
                    'collapsable' => true,
                    'collapsed' => false,
                ),
                ...
                'sounds_choice' => array(
                    ...
                    'name' => 'sounds_choice[]',
                    'caption' => _t('_modzzz_charity_form_caption_sounds_choice'),
                    'info' => _t('_modzzz_charity_form_info_sounds_choice'),
                    'required' => false,
                ),
                ...
                'sounds_upload' => array(
                    ...
                    'name' => 'sounds_upload[]',
                    'caption' => _t('_modzzz_charity_form_caption_sounds_upload'),
                    'info' => _t('_modzzz_charity_form_info_sounds_upload'),
                    'required' => false,
                ),
                ...
                'header_files' => array(
                    'type' => 'block_header',
                    'caption' => _t('_modzzz_charity_form_header_files'),
                    'collapsable' => true,
                    'collapsed' => false,
                ),
                ...
                'files_choice' => array(
                    ...
                    'name' => 'files_choice[]',
                    'caption' => _t('_modzzz_charity_form_caption_files_choice'),
                    'info' => _t('_modzzz_charity_form_info_files_choice'),
                    'required' => false,
                ),
                ...
                'files_upload' => array(
                    ...
                    'name' => 'files_upload[]',
                    'caption' => _t('_modzzz_charity_form_caption_files_upload'),
                    'info' => _t('_modzzz_charity_form_info_files_upload'),
                    'required' => false,
                ),
				*/
                ...
                'header_privacy' => array(
                    'type' => 'block_header',
                    'caption' => _t('_modzzz_charity_form_header_privacy'),
                ),
                ...
                'allow_view_charity_to' => $this->_oMain->_oPrivacy->getGroupChooser($iProfileId, 'charity', 'view_charity'),
                ...
                'allow_join_to' => $this->_oMain->_oPrivacy->getGroupChooser($iProfileId, 'charity', 'join'),
       ...
       if (!isset($this->_aMedia['images'])) {
        ...
        if ($GLOBALS['oBxCharityModule']->isAdmin()) {

            require_once(BX_DIRECTORY_PATH_INC . 'membership_levels.inc.php');
            $aMemberships = getMemberships ();
            unset ($aMemberships[MEMBERSHIP_ID_NON_MEMBER]); // unset Non-member
            $aMemberships = array('' => _t('_modzzz_charity_membership_filter_none')) + $aMemberships;
            $aFormInputsAdminPart = array (
 
				'membership_view_filter' => array(
					'type' => 'select',
					'name' => 'membership_view_filter',
					'caption' => _t('_modzzz_charity_caption_membership_view_filter'), 
					'info' => _t('_modzzz_charity_info_membership_view_filter'), 
					'values' => $aMemberships,
					'value' => '', 
					'checker' => array (
					'func' => 'preg',
					'params' => array('/^[0-9a-zA-Z]*$/'),
					'error' => _t ('_modzzz_charity_err_membership_view_filter'),
					),                                        
					'db' => array (
					'pass' => 'Preg', 
					'params' => array('/([0-9a-zA-Z]*)/'),
    ...
    function processMembershipChecksForMediaUploads (&$aInputs) {
        ...
        foreach ($a as $k => $v) {
            ...
            if ((!defined("BX_{$v}_ADD") || $aCheck[CHECK_ACTION_RESULT] != CHECK_ACTION_RESULT_ALLOWED) && !$isAdmin) {
				...
				if(($k=='videos') && (getParam("modzzz_charity_allow_embed")!="on")){
        ...
        $a = array ('images' => 'PHOTOS', 'videos' => 'VIDEOS', 'sounds' => 'SOUNDS', 'files' => 'FILES');
        foreach ($a as $k => $v) {
			if (defined("BX_CHARITY_{$v}_ADD"))
				$aCheck = checkAction($_COOKIE['memberID'], constant("BX_CHARITY_{$v}_ADD"));
            if ((!defined("BX_CHARITY_{$v}_ADD") || $aCheck[CHECK_ACTION_RESULT] != CHECK_ACTION_RESULT_ALLOWED) && !$isAdmin) {
                unset($this->_aMedia[$k]);
                unset($aInputs['header_'.$k]);
                unset($aInputs[$k.'_choice']);
                unset($aInputs[$k.'_upload']);
