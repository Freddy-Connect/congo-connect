...
class BxCharityEventPageBrowse extends BxDolTwigPageMain {

    function BxCharityEventPageBrowse(&$oMain, $sUri) {
		...
		parent::BxDolTwigPageMain('modzzz_charity_events_browse', $oMain);
	}
