...
class BxCharitySupporterFormAdd extends BxDolFormMedia {

    var $_oMain, $_oDb;

    function BxCharitySupporterFormAdd ($oMain, $iProfileId, $iSupporterId = 0, $iEntryId = 0, $iThumb = 0) { 
        $this->_oMain = $oMain;
        $this->_oDb = $oMain->_oDb; 
		$this->_oDb->_sTableMediaPrefix = $this->_oDb->_sTableSupporterMediaPrefix;
 
		bx_import ('SubPrivacy', $this->_oMain->_aModule);
		$GLOBALS['oBxCharityModule']->_oSubPrivacy = new BxCharitySubPrivacy($this->_oMain, $this->_oDb->_sTableSupporter); 
