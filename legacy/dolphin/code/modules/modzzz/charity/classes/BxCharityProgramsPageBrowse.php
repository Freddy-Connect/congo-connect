...
class BxCharityProgramsPageBrowse extends BxDolTwigPageMain {

    function BxCharityProgramsPageBrowse(&$oMain, $sUri) {
		...
		parent::BxDolTwigPageMain('modzzz_charity_programs_browse', $oMain);
	}
  
    function getBlockCode_Browse () {
 
        $this->sUrlStart = BX_DOL_URL_ROOT . $this->oConfig->getBaseUri() .  'programs/browse/' . $this->sUri . '?';
