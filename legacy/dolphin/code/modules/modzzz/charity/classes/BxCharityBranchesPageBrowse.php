...
class BxCharityBranchesPageBrowse extends BxDolTwigPageMain {

    function BxCharityBranchesPageBrowse(&$oMain, $sUri) {
		...
		parent::BxDolTwigPageMain('modzzz_charity_branches_browse', $oMain);
	}
  
    function getBlockCode_Browse () {
 
        $this->sUrlStart = BX_DOL_URL_ROOT . $this->oConfig->getBaseUri() .  'branches/browse/' . $this->sUri . '?';
