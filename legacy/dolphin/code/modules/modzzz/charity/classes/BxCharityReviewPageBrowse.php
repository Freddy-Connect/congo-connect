...
class BxCharityReviewPageBrowse extends BxDolTwigPageMain {

    function BxCharityReviewPageBrowse(&$oMain, $sUri) {
		...
		parent::BxDolTwigPageMain('modzzz_charity_reviews_browse', $oMain);
	}
