...
class BxCharityFormPrivacy extends BxTemplFormView {

    function BxCharityFormPrivacy (&$oMain, $iId) {
        ...
        $aCustomForm = array(
            ...
            'inputs' => array(
                ...
                'header_privacy' => array(
                    'type' => 'block_header',
                    'caption' => _t('_modzzz_charity_privacy_view_location'),
                ),

                'allow_view_location_to' => $oMain->_oPrivacy->getGroupChooser($iId, 'charity', 'view_location'),
