...
class BxCharityEventFormAdd extends BxDolFormMedia {

    var $_oMain, $_oDb;

    function BxCharityEventFormAdd ($oMain, $iProfileId, $iEventId = 0, $iEntryId = 0, $iThumb = 0) { 
        $this->_oMain = $oMain;
        $this->_oDb = $oMain->_oDb; 
		$this->_oDb->_sTableMediaPrefix = $this->_oDb->_sTableEventMediaPrefix;
 
		bx_import ('SubPrivacy', $this->_oMain->_aModule);
		$GLOBALS['oBxCharityModule']->_oSubPrivacy = new BxCharitySubPrivacy($this->_oMain, $this->_oDb->_sTableEvent); 
       ...
       $this->_aMedia = array ();
        ...
        $aCategories = $oProfileFields->convertValues4Input('#!CharityEventCategories');
 		asort($aCategories);
        ...
        $aInputPrivacyView = $GLOBALS['oBxCharityModule']->_oSubPrivacy->getGroupChooser($iProfileId, 'charity', 'view');
        ...
        $aInputPrivacyComment = $GLOBALS['oBxCharityModule']->_oSubPrivacy->getGroupChooser($iProfileId, 'charity', 'comment');
        ...
        $aInputPrivacyRate = $GLOBALS['oBxCharityModule']->_oSubPrivacy->getGroupChooser($iProfileId, 'charity', 'rate');
        ...
        $aInputPrivacyUploadPhotos = $this->_oMain->_oSubPrivacy->getGroupChooser($iProfileId, 'charity', 'upload_photos');
        $aInputPrivacyUploadPhotos['values'] = $aInputPrivacyCustom2;
        $aInputPrivacyUploadPhotos['db'] = $aInputPrivacyCustom2Pass;

        $aInputPrivacyUploadVideos = $this->_oMain->_oSubPrivacy->getGroupChooser($iProfileId, 'charity', 'upload_videos');
        $aInputPrivacyUploadVideos['values'] = $aInputPrivacyCustom2;
        $aInputPrivacyUploadVideos['db'] = $aInputPrivacyCustom2Pass;        

        $aInputPrivacyUploadSounds = $this->_oMain->_oSubPrivacy->getGroupChooser($iProfileId, 'charity', 'upload_sounds');
        $aInputPrivacyUploadSounds['values'] = $aInputPrivacyCustom2;
        $aInputPrivacyUploadSounds['db'] = $aInputPrivacyCustom2Pass;

        $aInputPrivacyUploadFiles = $this->_oMain->_oSubPrivacy->getGroupChooser($iProfileId, 'charity', 'upload_files');
        ...
        $aCustomForm = array(
            ...
            'inputs' => array(
                ...
                'title' => array(
                    'type' => 'text',
                    'name' => 'title',
                    'caption' => _t('_modzzz_charity_caption_title'),
                    'required' => true,
                    'checker' => array (
                        'func' => 'length',
                        'params' => array(3,100),
                        'error' => _t ('_modzzz_charity_err_title'),
                    ),
                    'db' => array (
                        'pass' => 'Xss', 
                    ),
                ...
                'desc' => array(
                    'type' => 'textarea',
                    'name' => 'desc',
                    'caption' => _t('_modzzz_charity_caption_desc'),
                    'required' => true,
                    'html' => 2,
                    'checker' => array (
                        'func' => 'length',
                        'params' => array(20,64000),
                        'error' => _t ('_modzzz_charity_err_desc'),
                    ),                    
                    'db' => array (
                        'pass' => 'XssHtml', 
                    ),                    
                ...
                'event_start' => array(
                    'type' => 'datetime',
                    'name' => 'event_start',
                    'caption' => _t('_modzzz_charity_caption_event_start'),
                    'required' => true,
                    'checker' => array (
                        'func' => 'DateTime',
                        'error' => _t ('_modzzz_charity_err_event_start'),
                    ),
                    'db' => array (
                        'pass' => 'DateTime', 
                    ),    
                ...
                'event_end' => array(
                    'type' => 'datetime',
                    'name' => 'event_end',
                    'caption' => _t('_modzzz_charity_caption_event_end'),
                    'required' => true,
                    'checker' => array (
                        'func' => 'DateTime',
                        'error' => _t ('_modzzz_charity_err_event_end'),
                    ),
                    'db' => array (
                        'pass' => 'DateTime', 
                    ),                    
			...
			/*		
                'tags' => array(
                    ...
                    'checker' => array (
                        'func' => 'avail',
                        'error' => _t ('_modzzz_charity_err_tags'),
                    ),
                    'db' => array (
                        'pass' => 'Tags', 
                    ),
			...
			*/
                ...
                'header_location' => array(
                    'type' => 'block_header',
                    'caption' => _t('_modzzz_charity_form_header_location'),
                    'collapsable' => true,
                    'collapsed' => false,
                ),
                'country' => array(
                ...
                'city' => array(
                    ...
                    'checker' => array (
                        'func' => 'length',
                        'params' => array(3,100),
                        'error' => _t ('_modzzz_charity_err_city'),
                    ),
                    'db' => array (
                        'pass' => 'Xss', 
                    ),                
                ...
                'place' => array(
                    'type' => 'text',
                    'name' => 'place',
                    'caption' => _t('_modzzz_charity_caption_place'),
                    'required' => true,
                    'checker' => array (
                        'func' => 'avail',
                        'error' => _t ('_modzzz_charity_err_place'),
                    ),
                    'db' => array (
                        'pass' => 'Xss', 
                    ),
                ...
                'header_images' => array(
                    'type' => 'block_header',
                    'caption' => _t('_modzzz_charity_subprofile_form_header_images'),
                    'collapsable' => true,
                    'collapsed' => false,
                ),
                'thumb' => array(
                ...
                'header_videos' => array(
                    'type' => 'block_header',
                    'caption' => _t('_modzzz_charity_subprofile_form_header_videos'),
                    'collapsable' => true,
                    'collapsed' => false,
                ),
                'videos_choice' => array(
                ...
                'header_sounds' => array(
                    'type' => 'block_header',
                    'caption' => _t('_modzzz_charity_subprofile_form_header_sounds'),
                    'collapsable' => true,
                    'collapsed' => false,
                ),
                'sounds_choice' => array(
                ...
                'header_files' => array(
                    'type' => 'block_header',
                    'caption' => _t('_modzzz_charity_subprofile_form_header_files'),
                    'collapsable' => true,
                    'collapsed' => false,
                ),
                'files_choice' => array(
