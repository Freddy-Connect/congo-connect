...
class BxCharityMembersFormAdd extends BxDolFormMedia {

    var $_oMain, $_oDb;

    function BxCharityMembersFormAdd ($oMain, $iProfileId, $iCharityId = 0, $iEntryId = 0, $iThumb = 0) { 
        $this->_oMain = $oMain;
        $this->_oDb = $oMain->_oDb; 
		$this->_oDb->_sTableMediaPrefix = $this->_oDb->_sTableMembersMediaPrefix;
         
		bx_import ('SubPrivacy', $this->_oMain->_aModule);
		$GLOBALS['oBxCharityModule']->_oSubPrivacy = new BxCharitySubPrivacy($this->_oMain, $this->_oDb->_sTableMembers); 
        ...
        $aCustomForm = array(
            ...
            'inputs' => array(
                ...
                'title' => array(
                    'type' => 'text',
                    'name' => 'title',
                    'caption' => _t('_modzzz_charity_form_caption_member_name'),
                    'required' => true,
                    'checker' => array (
                        'func' => 'length',
                        'params' => array(3,100),
                ...
                'position' => array(
                    'type' => 'text',
                    'name' => 'position',
                    'caption' => _t('_modzzz_charity_form_caption_position'),
                    'info' => _t('_modzzz_charity_form_info_position'), 
                    'required' => true,
                    'checker' => array (
                        'func' => 'length',
                        'params' => array(3,100),
