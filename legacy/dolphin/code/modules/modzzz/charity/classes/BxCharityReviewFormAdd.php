...
class BxCharityReviewFormAdd extends BxDolFormMedia {

    var $_oMain, $_oDb;

    function BxCharityReviewFormAdd ($oMain, $iProfileId, $iCharityId = 0, $iEntryId = 0, $iThumb = 0) { 
        $this->_oMain = $oMain;
        $this->_oDb = $oMain->_oDb;

		$this->_oDb->_sTableMediaPrefix = $this->_oDb->_sTableReviewMediaPrefix;
  		bx_import ('SubPrivacy', $this->_oMain->_aModule);
		$GLOBALS['oBxCharityModule']->_oSubPrivacy = new BxCharitySubPrivacy($this->_oMain, $this->_oDb->_sTableReview); 
        ...
        $aCustomForm = array(
            ...
            'inputs' => array(
                ...
                'desc' => array(
                    'type' => 'textarea',
                    'name' => 'desc',
                    'caption' => _t('_modzzz_charity_form_caption_desc'),
                    'required' => true,
                    'html' => 2,
                    'checker' => array (
                        'func' => 'length',
