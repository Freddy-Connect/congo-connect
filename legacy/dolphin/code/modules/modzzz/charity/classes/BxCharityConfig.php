...
class BxCharityConfig extends BxDolConfig {
	 ...
	 * Constructor
	 */
	function BxCharityConfig($aModule) {
	...
	function init(&$oDb) {
	    ...
	    $this->_sCurrencySign = $this->_oDb->getParam('modzzz_charity_currency_sign');
	    $this->_sCurrencyCode = $this->_oDb->getParam('modzzz_charity_currency_code');
        $this->_sPurchaseCurrency = $this->_oDb->getParam('modzzz_charity_currency_code'); 
        ...
        $this->_sPurchaseDonateUrl = BX_DOL_URL_ROOT . $this -> getBaseUri() . 'donation/process/';   
 
		$this->sReturnUrl = BX_DOL_URL_ROOT . $this -> getBaseUri() . 'view/';  
	    $this->_iSnippetLength = (int)$this->_oDb->getParam('modzzz_charity_snippet_length');
		$this->_iTitleLength = (int)$this->_oDb->getParam('modzzz_charity_title_length');	    

	}

	function getDonationUrl() {
	    return $this->_sPurchaseDonateUrl;
	}
