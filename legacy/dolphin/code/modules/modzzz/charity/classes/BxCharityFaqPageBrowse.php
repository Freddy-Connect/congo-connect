...
class BxCharityFaqPageBrowse extends BxDolTwigPageMain {

    function BxCharityFaqPageBrowse(&$oMain, $sUri) {
		...
		parent::BxDolTwigPageMain('modzzz_charity_faqs_browse', $oMain);
	}
  
    function getBlockCode_Browse () {
 
        $this->sUrlStart = BX_DOL_URL_ROOT . $this->oConfig->getBaseUri() .  'faq/browse/' . $this->sUri . '?';
