...
class BxCharityNewsFormAdd extends BxDolFormMedia {

    var $_oMain, $_oDb;

    function BxCharityNewsFormAdd ($oMain, $iProfileId, $iCharityId = 0, $iEntryId = 0, $iThumb = 0) { 
        $this->_oMain = $oMain;
        $this->_oDb = $oMain->_oDb; 
		$this->_oDb->_sTableMediaPrefix = $this->_oDb->_sTableNewsMediaPrefix;
 		
		bx_import ('SubPrivacy', $this->_oMain->_aModule);
		$GLOBALS['oBxCharityModule']->_oSubPrivacy = new BxCharitySubPrivacy($this->_oMain, $this->_oDb->_sTableNews); 
        ...
        $aInputPrivacyComment = $GLOBALS['oBxCharityModule']->_oPrivacy->getGroupChooser($iProfileId, 'charity', 'comment');
        ...
        $aInputPrivacyRate = $GLOBALS['oBxCharityModule']->_oPrivacy->getGroupChooser($iProfileId, 'charity', 'rate');
