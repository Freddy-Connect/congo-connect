...
class BxCharityMembersPageBrowse extends BxDolTwigPageMain {

    function BxCharityMembersPageBrowse(&$oMain, $sUri) {
		...
		parent::BxDolTwigPageMain('modzzz_charity_members_browse', $oMain);
	}
  
    function getBlockCode_Browse () {
 
        $this->sUrlStart = BX_DOL_URL_ROOT . $this->oConfig->getBaseUri() .  'members/browse/' . $this->sUri . '?';
