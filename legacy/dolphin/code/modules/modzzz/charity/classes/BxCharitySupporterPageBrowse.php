...
class BxCharitySupporterPageBrowse extends BxDolTwigPageMain {

    function BxCharitySupporterPageBrowse(&$oMain, $sUri) {
		...
		parent::BxDolTwigPageMain('modzzz_charity_supporters_browse', $oMain);
	}
  
    function getBlockCode_Browse () {
 
        $this->sUrlStart = BX_DOL_URL_ROOT . $this->oConfig->getBaseUri() .  'supporter/browse/' . $this->sUri . '?';
        ...
        return $this->ajaxBrowseSubProfile(
            'supporter',
            'supporters',
            $this->oDb->getParam('modzzz_charity_perpage_browse_subitems'), 
