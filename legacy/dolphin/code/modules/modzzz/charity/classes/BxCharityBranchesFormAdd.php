...
class BxCharityBranchesFormAdd extends BxDolFormMedia {

    var $_oMain, $_oDb;

    function BxCharityBranchesFormAdd ($oMain, $iProfileId, $iCharityId = 0, $iEntryId = 0, $iThumb = 0) { 
        $this->_oMain = $oMain;
        $this->_oDb = $oMain->_oDb; 
		$this->_oDb->_sTableMediaPrefix = $this->_oDb->_sTableBranchesMediaPrefix;
         
		bx_import ('SubPrivacy', $this->_oMain->_aModule);
		$GLOBALS['oBxCharityModule']->_oSubPrivacy = new BxCharitySubPrivacy($this->_oMain, $this->_oDb->_sTableBranches); 
        ...
        $aCustomForm = array(
            ...
            'inputs' => array(
                ...
                'title' => array(
                    'type' => 'text',
                    'name' => 'title',
                    'caption' => _t('_modzzz_charity_form_caption_branch_name'),
                    'required' => true,
                    'checker' => array (
                        'func' => 'length',
                        'params' => array(3,100),
