...
class BxCharityStaffPageBrowse extends BxDolTwigPageMain {

    function BxCharityStaffPageBrowse(&$oMain, $sUri) {
		...
		parent::BxDolTwigPageMain('modzzz_charity_staffs_browse', $oMain);
	}
  
    function getBlockCode_Browse () {
 
        $this->sUrlStart = BX_DOL_URL_ROOT . $this->oConfig->getBaseUri() .  'staff/browse/' . $this->sUri . '?';
