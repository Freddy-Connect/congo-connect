...
class BxCharityRequest extends BxDolRequest {

    function BxCharityRequest() {
        parent::BxDolRequest();
    }
    ...
    function processAsAction($aModule, &$aRequest, $sClass = "Module") {
        ...
        $GLOBALS['oTopMenu']->setCustomSubActions($aVars, 'modzzz_charity_title', false);

        return BxDolRequest::processAsAction($aModule, $aRequest, $sClass);
    }
}

BxCharityRequest::processAsAction($GLOBALS['aModule'], $GLOBALS['aRequest']);