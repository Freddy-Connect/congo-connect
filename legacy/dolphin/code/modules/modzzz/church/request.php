...
class BxChurchRequest extends BxDolRequest {

    function BxChurchRequest() {
        parent::BxDolRequest();
    }
    ...
    function processAsAction($aModule, &$aRequest, $sClass = "Module") {
        ...
        $GLOBALS['oTopMenu']->setCustomSubActions($aVars, 'modzzz_church_title', false);

        return BxDolRequest::processAsAction($aModule, $aRequest, $sClass);
    }
}

BxChurchRequest::processAsAction($GLOBALS['aModule'], $GLOBALS['aRequest']);