...
class BxChurchInstaller extends BxDolInstaller {

    function BxChurchInstaller($aConfig) {
    ...
    function install($aParams) {
		...
		BxDolService::call($this->_aConfig['home_uri'], 'branches_map_install'); 
        BxDolService::call($this->_aConfig['home_uri'], 'states_install');
    ...
    function uninstall($aParams) {
        ...
        if ($aResult['result'] && BxDolModule::getInstance('BxWmapModule')){
            ...
            BxDolService::call('wmap', 'part_uninstall', array($this->_aConfig['home_uri'].'_branches'));
		}
