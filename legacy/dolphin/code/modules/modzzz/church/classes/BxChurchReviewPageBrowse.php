...
class BxChurchReviewPageBrowse extends BxDolTwigPageMain {

    function BxChurchReviewPageBrowse(&$oMain, $sUri) {
		...
		parent::BxDolTwigPageMain('modzzz_church_reviews_browse', $oMain);
	}
