...
class BxChurchEventFormAdd extends BxDolFormMedia {

    var $_oMain, $_oDb;

    function BxChurchEventFormAdd ($oMain, $iProfileId, $iEventId = 0, $iEntryId = 0, $iThumb = 0) { 
        $this->_oMain = $oMain;
        $this->_oDb = $oMain->_oDb; 
		$this->_oDb->_sTableMediaPrefix = $this->_oDb->_sTableEventMediaPrefix;
 
		bx_import ('SubPrivacy', $this->_oMain->_aModule);
		$GLOBALS['oBxChurchModule']->_oSubPrivacy = new BxChurchSubPrivacy($this->_oMain, $this->_oDb->_sTableEvent); 
       ...
       $this->_aMedia = array ();
        ...
        $aCategories = $oProfileFields->convertValues4Input('#!ChurchEventCategories');
 		asort($aCategories);
		...
		if($iChurchId) {
			$aDataEntry = $this->_oDb->getEventEntryById($iChurchId); 
        ...
        $aInputPrivacyUploadPhotos = $this->_oMain->_oSubPrivacy->getGroupChooser($iProfileId, 'church', 'upload_photos');
        $aInputPrivacyUploadPhotos['values'] = $aInputPrivacyCustom2;
        $aInputPrivacyUploadPhotos['db'] = $aInputPrivacyCustom2Pass;

        $aInputPrivacyUploadVideos = $this->_oMain->_oSubPrivacy->getGroupChooser($iProfileId, 'church', 'upload_videos');
        $aInputPrivacyUploadVideos['values'] = $aInputPrivacyCustom2;
        $aInputPrivacyUploadVideos['db'] = $aInputPrivacyCustom2Pass;        

        $aInputPrivacyUploadSounds = $this->_oMain->_oSubPrivacy->getGroupChooser($iProfileId, 'church', 'upload_sounds');
        $aInputPrivacyUploadSounds['values'] = $aInputPrivacyCustom2;
        $aInputPrivacyUploadSounds['db'] = $aInputPrivacyCustom2Pass;

        $aInputPrivacyUploadFiles = $this->_oMain->_oSubPrivacy->getGroupChooser($iProfileId, 'church', 'upload_files');
        ...
        $aCustomForm = array(
            ...
            'inputs' => array(
                ...
                'header_info' => array(
                    'type' => 'block_header',
                    'caption' => _t('_modzzz_church_subprofile_form_header_info')
                ),                
                'church_id' => array(
                    'type' => 'hidden',
                    'name' => 'church_id', 
                ...
                'title' => array(
                    'type' => 'text',
                    'name' => 'title',
                    'caption' => _t('_modzzz_church_caption_title'),
                    'required' => true,
                    'checker' => array (
                        'func' => 'length',
                        'params' => array(3,100),
                ...
                'desc' => array(
                    'type' => 'textarea',
                    'name' => 'desc',
                    'caption' => _t('_modzzz_church_caption_desc'),
                    'required' => true,
                    'html' => 2,
                    'checker' => array (
                        'func' => 'length',
                ...
                'event_start' => array(
                    'type' => 'datetime',
                    'name' => 'event_start',
                    'caption' => _t('_modzzz_church_caption_event_start'),
                    'required' => true,
                    'checker' => array (
                        'func' => 'DateTime',
                        'error' => _t ('_modzzz_church_err_event_start'),
                    ),
                    'db' => array (
                        'pass' => 'DateTime', 
                    ),    
                ...
                'event_end' => array(
                    'type' => 'datetime',
                    'name' => 'event_end',
                    'caption' => _t('_modzzz_church_caption_event_end'),
                    'required' => true,
                    'checker' => array (
                        'func' => 'DateTime',
                        'error' => _t ('_modzzz_church_err_event_end'),
                    ),
                    'db' => array (
                        'pass' => 'DateTime', 
                    ),                    
			...
			/*		
                'tags' => array(
                    ...
                    'checker' => array (
                        'func' => 'avail',
                        'error' => _t ('_modzzz_church_err_tags'),
                    ),
                    'db' => array (
                        'pass' => 'Tags', 
                    ),
			...
			*/
                ...
                'header_location' => array(
                    'type' => 'block_header',
                    'caption' => _t('_modzzz_church_form_header_location'),
                    'collapsable' => true,
                    'collapsed' => false,
                ),
                'country' => array(
                    ...
                    'checker' => array (
                        ...
                        'error' => _t ('_modzzz_church_form_err_country'),
                    ),                                        
                    'db' => array (
                        'pass' => 'Preg', 
                        'params' => array('/([a-zA-Z]{2})/'),
                ...
                'city' => array(
                    ...
                    'checker' => array (
                        'func' => 'length',
                        'params' => array(3,100),
                        'error' => _t ('_modzzz_church_err_city'),
                    ),
                    'db' => array (
                        'pass' => 'Xss', 
                    ),                
                ...
                'place' => array(
                    'type' => 'text',
                    'name' => 'place',
                    'caption' => _t('_modzzz_church_caption_place'),
                    'required' => true,
                    'checker' => array (
                        'func' => 'avail',
                        'error' => _t ('_modzzz_church_err_place'),
                    ),
                    'db' => array (
                        'pass' => 'Xss', 
                    ),
                ...
                'header_images' => array(
                    'type' => 'block_header',
                    'caption' => _t('_modzzz_church_subprofile_form_header_images'),
                    'collapsable' => true,
                    'collapsed' => false,
                ),
                'thumb' => array(
                ...
                'header_videos' => array(
                    'type' => 'block_header',
                    'caption' => _t('_modzzz_church_subprofile_form_header_videos'),
                    'collapsable' => true,
                    'collapsed' => false,
                ),
                'videos_choice' => array(
                ...
                'header_sounds' => array(
                    'type' => 'block_header',
                    'caption' => _t('_modzzz_church_subprofile_form_header_sounds'),
                    'collapsable' => true,
                    'collapsed' => false,
                ),
                'sounds_choice' => array(
                ...
                'header_files' => array(
                    'type' => 'block_header',
                    'caption' => _t('_modzzz_church_subprofile_form_header_files'),
                    'collapsable' => true,
                    'collapsed' => false,
                ),
                'files_choice' => array(
