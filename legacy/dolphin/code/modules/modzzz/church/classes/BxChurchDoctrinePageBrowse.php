...
class BxChurchDoctrinePageBrowse extends BxDolTwigPageMain {

    function BxChurchDoctrinePageBrowse(&$oMain, $sUri) {
		...
		parent::BxDolTwigPageMain('modzzz_church_doctrines_browse', $oMain);
	}
  
    function getBlockCode_Browse () {
 
        $this->sUrlStart = BX_DOL_URL_ROOT . $this->oConfig->getBaseUri() .  'doctrine/browse/' . $this->sUri . '?';
