...
class BxChurchEventPageBrowse extends BxDolTwigPageMain {

    function BxChurchEventPageBrowse(&$oMain, $sUri) {
		...
		parent::BxDolTwigPageMain('modzzz_church_events_browse', $oMain);
	}
