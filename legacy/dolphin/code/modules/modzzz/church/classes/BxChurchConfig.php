...
class BxChurchConfig extends BxDolConfig {
	 ...
	 * Constructor
	 */
	function BxChurchConfig($aModule) {
	...
	function init(&$oDb) {
	    ...
	    $this->_sCurrencySign = $this->_oDb->getParam('modzzz_church_currency_sign');
	    $this->_sCurrencyCode = $this->_oDb->getParam('modzzz_church_currency_code');
        $this->_sPurchaseCurrency = $this->_oDb->getParam('modzzz_church_currency_code'); 
	    ...
	    $this->_iSnippetLength = (int)$this->_oDb->getParam('modzzz_church_snippet_length');
		$this->_iTitleLength = (int)$this->_oDb->getParam('modzzz_church_title_length');	    
