...
class BxChurchBranchesPageBrowse extends BxDolTwigPageMain {

    function BxChurchBranchesPageBrowse(&$oMain, $sUri) {
		...
		parent::BxDolTwigPageMain('modzzz_church_branches_browse', $oMain);
	}
