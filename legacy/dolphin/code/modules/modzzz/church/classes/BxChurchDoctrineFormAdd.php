...
class BxChurchDoctrineFormAdd extends BxDolFormMedia {

    var $_oMain, $_oDb;

    function BxChurchDoctrineFormAdd ($oMain, $iProfileId, $iDoctrineId = 0, $iEntryId = 0, $iThumb = 0) { 
        $this->_oMain = $oMain;
        $this->_oDb = $oMain->_oDb; 
		$this->_oDb->_sTableMediaPrefix = $this->_oDb->_sTableDoctrineMediaPrefix;
 
		bx_import ('SubPrivacy', $this->_oMain->_aModule);
		$GLOBALS['oBxChurchModule']->_oSubPrivacy = new BxChurchSubPrivacy($this->_oMain, $this->_oDb->_sTableDoctrine); 
