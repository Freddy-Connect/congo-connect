...
class BxChurchMembersPageBrowse extends BxDolTwigPageMain {

    function BxChurchMembersPageBrowse(&$oMain, $sUri) {
		...
		parent::BxDolTwigPageMain('modzzz_church_members_browse', $oMain);
	}
