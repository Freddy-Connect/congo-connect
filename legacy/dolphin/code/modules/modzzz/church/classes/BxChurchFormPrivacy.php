...
class BxChurchFormPrivacy extends BxTemplFormView {

    function BxChurchFormPrivacy (&$oMain, $iId) {
        ...
        $aCustomForm = array(
            ...
            'inputs' => array(
                ...
                'header_privacy' => array(
                    'type' => 'block_header',
                    'caption' => _t('_modzzz_church_privacy_view_location'),
                ),

                'allow_view_location_to' => $oMain->_oPrivacy->getGroupChooser($iId, 'church', 'view_location'),
