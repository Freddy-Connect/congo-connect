...
class BxChurchStaffFormAdd extends BxDolFormMedia {

    var $_oMain, $_oDb;

    function BxChurchStaffFormAdd ($oMain, $iProfileId, $iStaffId = 0, $iEntryId = 0, $iThumb = 0) { 
        $this->_oMain = $oMain;
        $this->_oDb = $oMain->_oDb; 
		$this->_oDb->_sTableMediaPrefix = $this->_oDb->_sTableStaffMediaPrefix;
 
		bx_import ('SubPrivacy', $this->_oMain->_aModule);
		$GLOBALS['oBxChurchModule']->_oSubPrivacy = new BxChurchSubPrivacy($this->_oMain, $this->_oDb->_sTableStaff); 
       ...
       $this->_aMedia = array ();
        ...
        $aCategories = $oProfileFields->convertValues4Input('#!ChurchStaffCategories');
 		asort($aCategories);
        ...
        $aCustomForm = array(
            ...
            'inputs' => array(
                ...
                'position' => array(
                    'type' => 'text',
                    'name' => 'position',
                    'caption' => _t('_modzzz_church_form_caption_position'),
                    'info' => _t('_modzzz_church_form_info_position'), 
                    'required' => true,
                    'checker' => array (
                        'func' => 'length',
                        'params' => array(3,100),
