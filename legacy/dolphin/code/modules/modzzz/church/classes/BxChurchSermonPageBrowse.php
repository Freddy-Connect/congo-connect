...
class BxChurchSermonPageBrowse extends BxDolTwigPageMain {

    function BxChurchSermonPageBrowse(&$oMain, $sUri) {
		...
		parent::BxDolTwigPageMain('modzzz_church_sermons_browse', $oMain);
	}
  
    function getBlockCode_Browse () {
 
        $this->sUrlStart = BX_DOL_URL_ROOT . $this->oConfig->getBaseUri() .  'sermon/browse/' . $this->sUri . '?';
