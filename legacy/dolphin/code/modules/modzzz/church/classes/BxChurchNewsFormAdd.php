...
class BxChurchNewsFormAdd extends BxDolFormMedia {

    var $_oMain, $_oDb;

    function BxChurchNewsFormAdd ($oMain, $iProfileId, $iChurchId = 0, $iEntryId = 0, $iThumb = 0) { 
        $this->_oMain = $oMain;
        $this->_oDb = $oMain->_oDb; 
		$this->_oDb->_sTableMediaPrefix = $this->_oDb->_sTableNewsMediaPrefix;
 		
		bx_import ('SubPrivacy', $this->_oMain->_aModule);
		$GLOBALS['oBxChurchModule']->_oSubPrivacy = new BxChurchSubPrivacy($this->_oMain, $this->_oDb->_sTableNews); 
       ...
       $this->_aMedia = array ();
        ...
        $aInputPrivacyComment = $GLOBALS['oBxChurchModule']->_oPrivacy->getGroupChooser($iProfileId, 'church', 'comment');
        ...
        $aInputPrivacyRate = $GLOBALS['oBxChurchModule']->_oPrivacy->getGroupChooser($iProfileId, 'church', 'rate');
