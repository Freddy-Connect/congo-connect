...
class BxChurchStaffPageBrowse extends BxDolTwigPageMain {

    function BxChurchStaffPageBrowse(&$oMain, $sUri) {
		...
		parent::BxDolTwigPageMain('modzzz_church_staffs_browse', $oMain);
	}
