...
class BxChurchNewsPageBrowse extends BxDolTwigPageMain {

    function BxChurchNewsPageBrowse(&$oMain, $sUri) {
		...
		parent::BxDolTwigPageMain('modzzz_church_news_browse', $oMain);
	}
