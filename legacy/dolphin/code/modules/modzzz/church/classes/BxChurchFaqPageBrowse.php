...
class BxChurchFaqPageBrowse extends BxDolTwigPageMain {

    function BxChurchFaqPageBrowse(&$oMain, $sUri) {
		...
		parent::BxDolTwigPageMain('modzzz_church_faqs_browse', $oMain);
	}
