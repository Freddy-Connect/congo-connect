...
class BxListingCoverPageMain extends BxDolTwigPageMain {

    function BxListingCoverPageMain(&$oMain) {
		...
		parent::BxDolTwigPageMain('modzzz_listingcover_main', $oMain);
	}
  
	function getListingCoverMain() {
