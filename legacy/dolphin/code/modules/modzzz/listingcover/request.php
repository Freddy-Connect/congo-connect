...
class BxListingCoverRequest extends BxDolRequest {

    function BxListingCoverRequest() {
        parent::BxDolRequest();
    }
    ...
    function processAsAction($aModule, &$aRequest, $sClass = "Module") {
        ...
        $GLOBALS['oTopMenu']->setCustomSubActions($aVars, 'modzzz_listingcover_title', false);

        return BxDolRequest::processAsAction($aModule, $aRequest, $sClass);
    }
}

BxListingCoverRequest::processAsAction($GLOBALS['aModule'], $GLOBALS['aRequest']);
