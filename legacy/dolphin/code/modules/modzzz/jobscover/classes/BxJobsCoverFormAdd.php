...
class BxJobsCoverFormAdd extends BxDolFormMedia {

    var $_oMain, $_oDb;

    function BxJobsCoverFormAdd ($oMain, $iJobsId = 0, $iEntryId = 0, $iThumb = 0) { 
        $this->_oMain = $oMain;
        ...
        if (BxDolRequest::serviceExists('photos', 'perform_photo_upload', 'Uploader'))
            $this->_aMedia['images'] = array (
                ...
                'tag' => MODZZZ_JOBSCOVER_PHOTOS_TAG,
                'cat' => MODZZZ_JOBSCOVER_PHOTOS_CAT,
                'thumb' => 'thumb',
                'module' => 'photos',
                'title_upload_post' => 'images_titles',
                'title_upload' => _t('_modzzz_jobscover_form_caption_file_title'),
        ...
        $aCustomForm = array(
            ...
            'inputs' => array(
                ...
                'header_info' => array(
                    'type' => 'block_header',
                    'caption' => _t('_modzzz_jobscover_form_header_images')
                ),                
                'jobs_id' => array(
                    'type' => 'hidden',
                    'name' => 'jobs_id', 
                ...
                'thumb' => array(
                    ...
                    'name' => 'thumb',
                    'caption' => _t('_modzzz_jobscover_form_caption_thumb_choice'),
                    'info' => _t('_modzzz_jobscover_form_info_thumb_choice'),
                    'required' => false,
                    'db' => array (
                        'pass' => 'Int',
                    ),
                ...
                'images_upload' => array(
                    ...
                    'name' => 'images_upload[]',
                    'caption' => _t('_modzzz_jobscover_form_caption_images_upload'),
                    'info' => _t('_modzzz_jobscover_form_info_images_upload'),
                    'required' => false,
                ),  
				'Submit' => array (
					'type' => 'submit',
