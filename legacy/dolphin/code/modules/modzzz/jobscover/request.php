...
class BxJobsCoverRequest extends BxDolRequest {

    function BxJobsCoverRequest() {
        parent::BxDolRequest();
    }
    ...
    function processAsAction($aModule, &$aRequest, $sClass = "Module") {
        ...
        $GLOBALS['oTopMenu']->setCustomSubActions($aVars, 'modzzz_jobscover_title', false);

        return BxDolRequest::processAsAction($aModule, $aRequest, $sClass);
    }
}

BxJobsCoverRequest::processAsAction($GLOBALS['aModule'], $GLOBALS['aRequest']);
