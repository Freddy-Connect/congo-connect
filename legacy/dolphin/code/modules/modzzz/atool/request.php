...
class BxAToolRequest extends BxDolRequest {

    function BxAToolRequest() {
        parent::BxDolRequest();
    }
    ...
    function processAsAction($aModule, &$aRequest, $sClass = "Module") {
        ...
        $GLOBALS['oTopMenu']->setCustomSubActions($aVars, 'modzzz_atool_title', false);

        return BxDolRequest::processAsAction($aModule, $aRequest, $sClass);
    }
}

BxAToolRequest::processAsAction($GLOBALS['aModule'], $GLOBALS['aRequest']);