...
class BxAToolFormCmtAdd extends BxDolFormMedia {

    var $_oMain, $_oDb;

    function BxAToolFormCmtAdd ($oMain) {
		...
		$aCustomForm = array(
            ...
            'inputs' => array(
                'header_info' => array(
                    'type' => 'block_header',
                    'caption' => _t('_modzzz_atool_form_header_send_cmt')
                ),  
                'recipient' => array(
                    'type' => 'text',
                    'name' => 'recipient',
                ...
                'cmt' => array(
                    'type' => 'textarea',
                    'name' => 'desc',
                    'caption' => _t('_modzzz_atool_form_caption_cmt'),
                    'required' => true,
                    'html' => 2,
                    'checker' => array (
                        'func' => 'avail', 
                        'error' => _t ('_modzzz_atool_form_err_cmt'),
                    ) 
                ), 
                'Submit' => array (
                    'type' => 'submit',
