...
class BxAToolInstaller extends BxDolInstaller {

    function BxAToolInstaller($aConfig) {
...
*/
        ...
        BxDolService::call($this->_aConfig['home_uri'], 'initialize');
...
*/
        ...
        BxDolService::call($this->_aConfig['home_uri'], 'cleanup');
