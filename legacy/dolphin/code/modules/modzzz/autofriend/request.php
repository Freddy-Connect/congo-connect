...
*     copyright            : (C) 2007 BoonEx AutoFriend
...
class BxAutoFriendRequest extends BxDolRequest {

    function BxAutoFriendRequest() {
        parent::BxDolRequest();
    }
    ...
    function processAsAction($aModule, &$aRequest, $sClass = "Module") {
        ...
        $GLOBALS['oTopMenu']->setCustomSubActions($aVars, 'modzzz_autofriend_title', false);

        return BxDolRequest::processAsAction($aModule, $aRequest, $sClass);
    }
}

BxAutoFriendRequest::processAsAction($GLOBALS['aModule'], $GLOBALS['aRequest']);