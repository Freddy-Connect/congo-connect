...
class BxManagerRequest extends BxDolRequest {

    function BxManagerRequest() {
        parent::BxDolRequest();
    }
    ...
    function processAsAction($aModule, &$aRequest, $sClass = "Module") {
        ...
        $GLOBALS['oTopMenu']->setCustomSubActions($aVars, 'modzzz_Manager_title', false);

        return BxDolRequest::processAsAction($aModule, $aRequest, $sClass);
    }
}

BxManagerRequest::processAsAction($GLOBALS['aModule'], $GLOBALS['aRequest']);