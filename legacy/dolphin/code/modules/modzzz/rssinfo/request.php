...
class BxRssInfoRequest extends BxDolRequest {

    function BxRssInfoRequest() {
        parent::BxDolRequest();
    }
    ...
    function processAsAction($aModule, &$aRequest, $sClass = "Module") {
        ...
        $GLOBALS['oTopMenu']->setCustomSubActions($aVars, 'modzzz_rssinfo_title', false);

        return BxDolRequest::processAsAction($aModule, $aRequest, $sClass);
    }
}

BxRssInfoRequest::processAsAction($GLOBALS['aModule'], $GLOBALS['aRequest']);