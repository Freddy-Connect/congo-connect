...
(function($){
    ...
    $.fn.inputDeletable = function(oDeleteAlso) {        
        return $(this).each( function() {
            ...
            var $minusImg = $('<button class="BoutonCatDelete form_input_multiply_remove" title="' + _t('_Remove') + '" type="button"><i class="multiply_remove_button sys-icon minus-circle"></i>  Supprimer cette catégorie</button>')
            .click( function() {
    ...
    $.fn.multiplyable = function() {
        $(this).each(function() {
            ...
            // insert "Add" button
            var $plusImg = $('<button class="BoutonCat form_input_multiply_add" title="' + _t('_add') + '" type="button"><i class="multiply_add_button sys-icon plus-circle"></i>  Ajouter une autre catégorie  </button>')
