...
class BxListingRequest extends BxDolRequest {

    function BxListingRequest() {
        parent::BxDolRequest();
    }
    ...
    function processAsAction($aModule, &$aRequest, $sClass = "Module") {
        ...
        $GLOBALS['oTopMenu']->setCustomSubActions($aVars, 'modzzz_listing_title', false);

        return BxDolRequest::processAsAction($aModule, $aRequest, $sClass);
    }
}

BxListingRequest::processAsAction($GLOBALS['aModule'], $GLOBALS['aRequest']);