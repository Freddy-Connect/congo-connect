...
class BxListingReviewPageBrowse extends BxDolTwigPageMain {

    function BxListingReviewPageBrowse(&$oMain, $sUri) {
		...
		parent::BxDolTwigPageMain('modzzz_listing_reviews_browse', $oMain);
	}
