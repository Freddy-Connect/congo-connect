...
class BxListingNewsPageBrowse extends BxDolTwigPageMain {

    function BxListingNewsPageBrowse(&$oMain, $sUri) {
		...
		parent::BxDolTwigPageMain('modzzz_listing_news_browse', $oMain);
	}
  
    function getBlockCode_Browse () {
 
        $this->sUrlStart = BX_DOL_URL_ROOT . $this->oConfig->getBaseUri() .  'news/browse/' . $this->sUri . '?';
