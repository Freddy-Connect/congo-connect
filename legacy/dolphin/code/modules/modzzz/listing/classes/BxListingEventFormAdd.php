...
class BxListingEventFormAdd extends BxDolFormMedia {

    var $_oMain, $_oDb;

    function BxListingEventFormAdd ($oMain, $iProfileId, $iEventId = 0, $iEntryId = 0, $iThumb = 0) { 
        $this->_oMain = $oMain;
        $this->_oDb = $oMain->_oDb; 
		$this->_oDb->_sTableMediaPrefix = $this->_oDb->_sTableEventMediaPrefix;
 
		bx_import ('SubPrivacy', $this->_oMain->_aModule);
		$GLOBALS['oBxListingModule']->_oSubPrivacy = new BxListingSubPrivacy($this->_oMain, $this->_oDb->_sTableEvent); 
        ...
        $aInputPrivacyUploadPhotos = $this->_oMain->_oSubPrivacy->getGroupChooser($iProfileId, 'listing', 'upload_photos');
        $aInputPrivacyUploadPhotos['values'] = $aInputPrivacyCustom2;
        $aInputPrivacyUploadPhotos['db'] = $aInputPrivacyCustom2Pass;

        $aInputPrivacyUploadVideos = $this->_oMain->_oSubPrivacy->getGroupChooser($iProfileId, 'listing', 'upload_videos');
        $aInputPrivacyUploadVideos['values'] = $aInputPrivacyCustom2;
        $aInputPrivacyUploadVideos['db'] = $aInputPrivacyCustom2Pass;        

        $aInputPrivacyUploadSounds = $this->_oMain->_oSubPrivacy->getGroupChooser($iProfileId, 'listing', 'upload_sounds');
        $aInputPrivacyUploadSounds['values'] = $aInputPrivacyCustom2;
        $aInputPrivacyUploadSounds['db'] = $aInputPrivacyCustom2Pass;

        $aInputPrivacyUploadFiles = $this->_oMain->_oSubPrivacy->getGroupChooser($iProfileId, 'listing', 'upload_files');
        ...
        $aCustomForm = array(
            ...
            'inputs' => array(
                ...
                'place' => array(
                    'type' => 'text',
                    'name' => 'place',
                    'caption' => _t('_modzzz_listing_form_caption_place'),
                    'required' => true,
                    'checker' => array (
                        'func' => 'avail',
                        'error' => _t ('_modzzz_listing_form_err_place'),
                    ),
                    'db' => array (
                        'pass' => 'Xss', 
                    ),
                ...
                'country' => array(
 				...
 				'state' => array(
					...
					'value' => $sSelState,  
					'values'=> $aStates,
					'caption' => _t('_modzzz_listing_form_caption_state'),
					'attrs' => array(
						'id' => 'substate',
					), 
				    'db' => array (
                ...
                'address1' => array(
                    'type' => 'text',
                    'name' => 'address1',
                    'caption' => _t('_modzzz_listing_form_caption_street'),
                    'required' => false, 
                    'db' => array (
                        'pass' => 'Xss', 
                    ),
                ...
                'event_start' => array(
                    'type' => 'datetime',
                    'name' => 'event_start',
                    'caption' => _t('_modzzz_listing_form_caption_event_start'),
                    'required' => true,
                    'checker' => array (
                        'func' => 'DateTime',
                        'error' => _t ('_modzzz_listing_form_err_event_start'),
                    ),
                    'db' => array (
                        'pass' => 'DateTime', 
                    ),    
                ...
                'event_end' => array(
                    'type' => 'datetime',
                    'name' => 'event_end',
                    'caption' => _t('_modzzz_listing_form_caption_event_end'), 
					'required' => true,
                    'checker' => array (
                        'func' => 'DateTime',
                        'error' => _t ('_modzzz_listing_form_err_event_end'),
                    ), 
                    'db' => array (
                        'pass' => 'DateTime', 
                    ),                    
