...
class BxInvestmentRequest extends BxDolRequest {

    function BxInvestmentRequest() {
        parent::BxDolRequest();
    }
    ...
    function processAsAction($aModule, &$aRequest, $sClass = "Module") {
        ...
        $GLOBALS['oTopMenu']->setCustomSubActions($aVars, 'modzzz_investment_title', false);

        return BxDolRequest::processAsAction($aModule, $aRequest, $sClass);
    }
}

BxInvestmentRequest::processAsAction($GLOBALS['aModule'], $GLOBALS['aRequest']);