...
class BxClassifiedConfig extends BxDolConfig {
	 ...
	 * Constructor
	 */
	function BxClassifiedConfig($aModule) {
	...
	function init(&$oDb) {
	    ...
	    $this->_sCurrencySign = $this->_oDb->getParam('modzzz_classified_currency_sign');
	    $this->_sCurrencyCode = $this->_oDb->getParam('modzzz_classified_currency_code');
        $this->_sPurchaseCurrency = $this->_oDb->getParam('modzzz_classified_currency_code'); 
