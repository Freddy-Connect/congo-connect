...
class BxClassifiedFormPrivacy extends BxTemplFormView {

    function BxClassifiedFormPrivacy (&$oMain, $iId) {
        ...
        $aCustomForm = array(
            ...
            'inputs' => array(
                ...
                'header_privacy' => array(
                    'type' => 'block_header',
                    'caption' => _t('_modzzz_classified_privacy_view_location'),
                ),

                'allow_view_location_to' => $oMain->_oPrivacy->getGroupChooser($iId, 'classified', 'view_location'),
