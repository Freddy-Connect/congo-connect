...
class BxClassifiedRequest extends BxDolRequest {

    function BxClassifiedRequest() {
        parent::BxDolRequest();
    }
    ...
    function processAsAction($aModule, &$aRequest, $sClass = "Module") {
        ...
        $GLOBALS['oTopMenu']->setCustomSubActions($aVars, 'modzzz_classified_title', false);

        return BxDolRequest::processAsAction($aModule, $aRequest, $sClass);
    }
}

BxClassifiedRequest::processAsAction($GLOBALS['aModule'], $GLOBALS['aRequest']);