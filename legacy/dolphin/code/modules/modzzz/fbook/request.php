...
class BxFBookRequest extends BxDolRequest {

    function BxFBookRequest() {
        parent::BxDolRequest();
    }
    ...
    function processAsAction($aModule, &$aRequest, $sClass = "Module") {
        ...
        $GLOBALS['oTopMenu']->setCustomSubActions($aVars, 'modzzz_fbook_title', false);

        return BxDolRequest::processAsAction($aModule, $aRequest, $sClass);
    }
}

BxFBookRequest::processAsAction($GLOBALS['aModule'], $GLOBALS['aRequest']);