...
class BxMemLogRequest extends BxDolRequest {

    function BxMemLogRequest() {
        parent::BxDolRequest();
    }
    ...
    function processAsAction($aModule, &$aRequest, $sClass = "Module") {
        ...
        $GLOBALS['oTopMenu']->setCustomSubActions($aVars, 'modzzz_memlog_title', false);

        return BxDolRequest::processAsAction($aModule, $aRequest, $sClass);
    }
}

BxMemLogRequest::processAsAction($GLOBALS['aModule'], $GLOBALS['aRequest']);