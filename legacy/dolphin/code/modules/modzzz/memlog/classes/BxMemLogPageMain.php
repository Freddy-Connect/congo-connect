...
class BxMemLogPageMain extends BxDolTwigPageMain {

    function BxMemLogPageMain(&$oMain) {
  
        $this->sSearchResultClassName = 'BxMemLogSearchResult';
        $this->sFilterName = 'memlog_filter';
		parent::BxDolTwigPageMain('modzzz_memlog_main', $oMain);
	}
 
	function getMemLogMain() {
        return BxDolModule::getInstance('BxMemLogModule');
    }
  
    function ajaxBrowse($sMode, $iPerPage, $aMenu = array(), $sValue = '', $isPublicOnly=false)
    {
