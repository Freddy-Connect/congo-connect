...
class BxProfessionalRequest extends BxDolRequest {

    function BxProfessionalRequest() {
        parent::BxDolRequest();
    }
    ...
    function processAsAction($aModule, &$aRequest, $sClass = "Module") {
        ...
        $GLOBALS['oTopMenu']->setCustomSubActions($aVars, 'modzzz_professional_title', false);

        return BxDolRequest::processAsAction($aModule, $aRequest, $sClass);
    }
}

BxProfessionalRequest::processAsAction($GLOBALS['aModule'], $GLOBALS['aRequest']);