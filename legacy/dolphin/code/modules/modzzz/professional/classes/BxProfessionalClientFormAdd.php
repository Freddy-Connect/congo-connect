...
class BxProfessionalClientFormAdd extends BxDolFormMedia {

    var $_oMain, $_oDb;

    function BxProfessionalClientFormAdd ($oMain, $iProfileId, $iProfessionalId = 0, $iEntryId = 0, $iThumb = 0) { 
        $this->_oMain = $oMain;
		...
		$GLOBALS['oBxProfessionalModule']->_oSubPrivacy = new BxProfessionalSubPrivacy($this->_oMain, $this->_oDb->_sTableClient); 
        ...
        $aCustomForm = array(
            ...
            'inputs' => array(
                ...
                'header_info' => array(
                    'type' => 'block_header',
                    'caption' => _t('_modzzz_professional_form_client_header_info')
                ),                
                ...
                'title' => array(
                    'type' => 'text',
                    'name' => 'title',
                    'caption' => _t('_modzzz_professional_form_caption_client_name'),
                    'required' => true,
                    'checker' => array (
                        'func' => 'length',
                ...
                'desc' => array(
                    'type' => 'textarea',
                    'name' => 'desc',
                    'caption' => _t('_modzzz_professional_form_caption_client_details'),
                    'required' => true,
                    'html' => 2,
                    'checker' => array (
                        'func' => 'length',
                ...
                'name' => array(
                 ...
                 'website' => array(
                    ...
                    'info' => _t('_modzzz_professional_form_info_website'), 
                    'required' => false, 
                    'db' => array (
                        'pass' => 'Xss', 
                    ),
     ...
     * @access private
     */ 
    function _getFilesInEntry ($sModuleName, $sClientMethod, $sName, $sMediaType, $iIdProfile, $iEntryId)
    {             
        ...
        foreach ($aReadyMedia as $iMediaId)
        {
            switch ($sModuleName) {
            case 'photos':
                $aRow = BxDolService::call($sModuleName, $sClientMethod, array($iMediaId, 'icon'), 'Search');
                break;
            case 'videos':
                $aRow = BxDolService::call($sModuleName, $sClientMethod, array($iMediaId, 'browse'), 'Search');
                break;
            default:
                $aRow = BxDolService::call($sModuleName, $sClientMethod, array($iMediaId), 'Search');
            }
    ...
    function processMedia ($iEntryId, $iProfileId) { 
        ...
        foreach ($this->_aMedia as $sName => $a) {
            ...
            $aFiles = $this->_getFilesInEntry ($a['module'], $a['client_method'], $a['post'], $sName, (int)$iProfileId, $iEntryId);
	...
	function generateCustomYoutubeTemplate ($iProfileId, $iEntryId) {
		...
		$aYoutubes = $this->_oDb->getYoutubeVideos ($iEntryId, 'client'); 
