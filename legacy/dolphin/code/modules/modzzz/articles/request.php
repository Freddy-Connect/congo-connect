...
class BxArticlesRequest extends BxDolRequest {

    function BxArticlesRequest() {
        parent::BxDolRequest();
    }
    ...
    function processAsAction($aModule, &$aRequest, $sClass = "Module") {
        ...
        $GLOBALS['oTopMenu']->setCustomSubActions($aVars, 'modzzz_articles_title', false);

        return BxDolRequest::processAsAction($aModule, $aRequest, $sClass);
    }
}

BxArticlesRequest::processAsAction($GLOBALS['aModule'], $GLOBALS['aRequest']);