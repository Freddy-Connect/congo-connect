...
class BxArticlesFormSearch extends BxTemplFormView {

    function BxArticlesFormSearch () {
        ...
        $aCustomForm = array(
            ...
            'inputs' => array(
                'Keyword' => array(
                    'type' => 'text',
                    'name' => 'Keyword',
                    'caption' => _t('_modzzz_articles_form_caption_keyword'),
                    'required' => true,
                    'checker' => array (
                        'func' => 'length',
                        'params' => array(3,100),
                        'error' => _t ('_modzzz_articles_form_err_keyword'),
                    ),
                    'db' => array (
                        'pass' => 'Xss', 
                    ),
