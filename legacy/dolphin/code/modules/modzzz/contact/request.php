...
class BxContactRequest extends BxDolRequest {

    function BxContactRequest() {
        parent::BxDolRequest();
    }
    ...
    function processAsAction($aModule, &$aRequest, $sClass = "Module") {
        ...
        $GLOBALS['oTopMenu']->setCustomSubActions($aVars, 'modzzz_contact_title', false);

        return BxDolRequest::processAsAction($aModule, $aRequest, $sClass);
    }
}

BxContactRequest::processAsAction($GLOBALS['aModule'], $GLOBALS['aRequest']);