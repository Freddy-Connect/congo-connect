...
class BxFormationsRequest extends BxDolRequest {

    function BxFormationsRequest() {
        parent::BxDolRequest();
    }
    ...
    function processAsAction($aModule, &$aRequest, $sClass = "Module") {
        ...
        $GLOBALS['oTopMenu']->setCustomSubActions($aVars, 'modzzz_formations_title', false);

        return BxDolRequest::processAsAction($aModule, $aRequest, $sClass);
    }
}

BxFormationsRequest::processAsAction($GLOBALS['aModule'], $GLOBALS['aRequest']);