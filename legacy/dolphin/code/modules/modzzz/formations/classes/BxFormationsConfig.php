...
class BxFormationsConfig extends BxDolConfig {
	 ...
	 * Constructor
	 */
	function BxFormationsConfig($aModule) {
	    parent::BxDolConfig($aModule);

	     $this->_oDb = null; 
	     $this->_sIconsFolder = 'modzzz/formations/media/images/company/';
	     $this->_sResumeFolder = 'modzzz/formations/media/resume/'; 

        $this->sMediaPath = BX_DIRECTORY_PATH_MODULES . "modzzz/formations/media/"; 
		$this->sMediaUrl =  BX_DOL_URL_MODULES . "modzzz/formations/media/"; 
	...
	function init(&$oDb) {
	    ...
	    $this->_sCurrencySign = $this->_oDb->getParam('modzzz_formations_currency_sign');
	    $this->_sCurrencyCode = $this->_oDb->getParam('modzzz_formations_currency_code');
        $this->_sPurchaseCurrency = $this->_oDb->getParam('modzzz_formations_currency_code'); 
