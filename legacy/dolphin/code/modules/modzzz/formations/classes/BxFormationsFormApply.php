...
class BxFormationsFormApply extends BxTemplFormView {

    function BxFormationsFormApply ($oMain, $aDataEntry, $iProfileId) {
        ...
        $aCustomForm = array(
            ...
            'inputs' => array(
				 ...
				 'Email' => array(
                    'type' => 'email',
                    'name' => 'Email',
                    'caption' => _t('_modzzz_formations_form_caption_apply_Email'),
					'value' => $sEmail, 
					
					'attrs' => array (
                        'style' => 'height:40px',
                    ),
					'info' => _t('_modzzz_formations_form_info_apply_Email'),
                     'required' => true,
                    'checker' => array (
                        'func' => 'avail',
                        'error' => _t ('_modzzz_formations_listing_form_err_apply_Email'),
                    ),    
                    'db' => array (
                        'pass' => 'Xss', 
                    ) 
                    ...
                    'type' => 'text',
                    'name' => 'telephone',
                    'caption' => _t('_modzzz_formations_form_caption_apply_phone'),
					
					//'value' => $stelephone, 
					'attrs' => array (
                        'style' => 'height:40px',
                    ),
					'info' => _t('_modzzz_formations_form_info_apply_phone'),
                    'required' => true,
                    'checker' => array (
                        'func' => 'length',
                        'params' => array(8,20),
                        'error' => _t ('_modzzz_formations_form_err_apply_phone'),
                    ),
                    'db' => array (
                        'pass' => 'Xss', 
                    ) 
			    ...
			    'message' => array(
                    'type' => 'textarea',
                    'name' => 'message',
                    'caption' => _t('_modzzz_formations_form_caption_cover_letter'), 
					'attrs' => array (
                        'style' => 'height:100px',
                    ...
                    'checker' => array (
                        ...
                        'error' => _t('_modzzz_formations_form_err_cover_letter'),
                    ),
                    'db' => array (
                        'pass' => 'Xss', 
                    ),
         ...
         /*  Freddy commentaire
			    'resume_id' => array(
                    'type' => 'select',
                    'name' => 'resume_id',
                    'caption' => _t('_modzzz_formations_form_caption_select_resume'),
                    'info' => _t('_modzzz_formations_form_info_select_resume'),
                    'required' => false, 
                    'values' => $aResume,  
                    'db' => array (
                        'pass' => 'Xss', 
				...
				'resume' => array(
					'type' => 'custom',
					'name' => "resume",
					'caption' => _t('_modzzz_formations_form_caption_resume'), 
