...
class BxFormationsSearchResult extends BxDolTwigSearchResult {

    var $aCurrent = array(
        'name' => 'modzzz_formations',
        'title' => '_modzzz_formations_page_title_browse',
        'table' => 'modzzz_formations_main',
        'ownFields' => array('id', 'title', 'desc', 'uri', 'created', 'author_id', 'thumb', 'icon', 'rate', 'zip', 'parent_category_id','category_id','company_id','company_type', 'role','duration','vacancies','experience','qualification','skills','min_salary','max_salary','salary_type','currency','career_level','formation_type','formation_status','comments_count', 'tags','video_embed','membership_view_filter','post_type', 'currency', 'invoice_no','expiry_date', 'featured_expiry_date', 'country', 'city', 'state', 'address1', 'application_link','condition_admission'),
        ...
        'restriction' => array(
            ...
            'public' => array('value' => '', 'field' => 'allow_view_formation_to', 'operator' => '='),
    ...
    function BxFormationsSearchResult($sMode = '', $sValue = '', $sValue2 = '', $sValue3 = '', $sValue4 = '', $sValue5 = '', $sValue6 = '', $sValue7 = '') {        
        ...
        switch ($sMode) {
            ...
            case 'categories':
                ...
                $this->aCurrent['title'] = _t('_modzzz_formations_page_title_category').' - '.$sCategoryName;
				$this->aCurrent['restriction']['subcat'] = array( 'table' => 'modzzz_formations_categ', 'value' => $iCategoryId,'field' => 'parent','operator' => '=');
				$this->aCurrent['join']['cat'] = array(
					'type' => 'left',
					'table' => 'modzzz_formations_categ',
		   ...
		   //[begin] - local 
			case 'local_country':          
				...
				if($sValue2){
					...
					$this->aCurrent['restriction']['category'] = array( 'table' => 'modzzz_formations_categ', 'value' => $iCategoryId, 'field' => 'parent','operator' => '=');
				...
				$this->aCurrent['title'] = _t('_modzzz_formations_caption_browse_local', $sTitleStr);
			...
			case 'apply':
				$this->aCurrent['join']['application'] = array(
					'type' => 'inner',
					'table' => 'modzzz_formations_apply',
					'mainField' => 'id',
					'onField' => 'formation_id',
					'joinFields' => '',
				);	
   
                $iProfileId = $GLOBALS['oBxFormationsModule']->_oDb->getProfileIdByNickName ($sValue, false);
               
                if (!$iProfileId)
                    $this->isError = true;
                else
					$this->aCurrent['restriction']['application'] = array('value' => $iProfileId, 'field' => 'member_id', 'operator' => '=', 'table' => 'modzzz_formations_apply'); 

				$sValue = $GLOBALS['MySQL']->unescape($sValue);
                $this->sBrowseUrl = "browse/apply/$sValue";
                $this->aCurrent['title'] = ucfirst(strtolower($sValue)) . _t('_modzzz_formations_page_title_applications_by_author');
			...
			case 'local':
				...
				$this->aCurrent['restriction']['local'] = array('value' => $sValue, 'field' => 'company_city', 'operator' => '=', 'table' => 'modzzz_formations_companies'); 
				$this->aCurrent['restriction']['item'] = array('value' => $sValue2, 'field' => 'id', 'operator' => '!=');  

				$this->sBrowseUrl = "browse/local/$sValue/$sValue2";
				$this->aCurrent['title'] = _t('_modzzz_formations_caption_browse_local', $sValue);
				break;
			...
			case 'other':
				...
				$this->aCurrent['title'] = _t('_modzzz_formations_caption_browse_other', $sCompanyName);
				break;

			case 'company_formations':
				$oMain = $this->getMain();
				$sCompanyName = $oMain->_oDb->getCompanyName($sValue);

				$this->aCurrent['restriction']['id'] = array('value' => $sValue, 'field' => 'company_id', 'operator' => '=');  
				// Freddy modif 
				//$this->aCurrent['restriction']['type'] = array('value' => 'formation', 'field' => 'company_type', 'operator' => '=');  
				$this->aCurrent['restriction']['type'] = array('value' => 'listing', 'field' => 'company_type', 'operator' => '=');

				$this->sBrowseUrl = "browse/company_formations/$sValue";
				$this->aCurrent['title'] = _t('_modzzz_formations_caption_browse_company_formations', $sCompanyName);
				break;
			...
			case 'other_member':
				...
				$this->aCurrent['title'] = _t('_modzzz_formations_caption_browse_other', $sNickName);
				break;
            ...
            case 'pending':
                ...
                $this->aCurrent['title'] = _t('_modzzz_formations_page_title_pending_approval');
                unset($this->aCurrent['rss']);
            break;
            ...
            case 'my_expired': 
                ...
                $this->sBrowseUrl = "browse/user/" . getNickName($oMain->_iProfileId);
                $this->aCurrent['title'] = _t('_modzzz_formations_page_title_expired');
                unset($this->aCurrent['rss']);
            break;
            case 'order':  
                $oMain = $this->getMain();
                ...
                $this->aCurrent['title'] = _t('_modzzz_formations_page_title_orders');
                
				$this->aCurrent['join']['invoices'] = array(
					'type' => 'inner',
					'table' => 'modzzz_formations_invoices',
					'mainField' => 'invoice_no',
					'onField' => 'invoice_no',
					'joinFields' => array('formation_id', 'invoice_no','price','days','package_id','invoice_date','invoice_due_date','invoice_expiry_date','invoice_status'),   
				);	

				$this->aCurrent['join']['orders'] = array(
					'type' => 'inner',
					'table' => 'modzzz_formations_orders',
					'mainField' => 'invoice_no',
					'onField' => 'invoice_no',
            ...
            case 'invoice':  
                ...
                $this->aCurrent['title'] = _t('_modzzz_formations_page_title_invoices');
				...
				$this->aCurrent['join']['invoices'] = array(
					...
					'mainField' => 'id',
					'onField' => 'formation_id',
					'joinFields' => array('id','formation_id', 'invoice_no','price','days','package_id','invoice_status','invoice_date','invoice_due_date','invoice_expiry_date'),   
				);	
			...
			case 'quick': 
                ...
                $this->aCurrent['title'] = _t('_modzzz_formations_page_title_browse') .' - '. $sValue; 
				break;
		   //[begin] - local 
			case 'local_country':         
				$this->aCurrent['restriction']['local_country'] = array('value' => $sValue, 'field' => 'country', 'operator' => '='); 
            ...
            case 'search':
                ...
                $this->aCurrent['title'] = _t('_modzzz_formations_page_title_search_results');
                unset($this->aCurrent['rss']);
                break; 
            ...
            case 'user':
                ...
                $this->aCurrent['title'] = ucfirst(strtolower($sValue)) . _t('_modzzz_formations_page_title_browse_by_author');
                if (bx_get('rss')) {
                    $aData = getProfileInfo($iProfileId);
                    if ($aData['Avatar']) {
                        $a = array ('ID' => $aData['author_id'], 'Avatar' => $aData['thumb']);
            ...
            case 'joined':
                ...
                $this->aCurrent['title'] = ucfirst(strtolower($sValue)) . _t('_modzzz_formations_page_title_browse_by_author_joined_formations');
            ...
            case 'admin':
                ...
                $this->aCurrent['title'] = _t('_modzzz_formations_page_title_admin_formations');
                break;
            ...
            case 'category':
                ...
                $this->aCurrent['title'] = _t('_modzzz_formations_page_title_browse_by_category') . ' ' . $sValue;
                break;
            ...
            case 'tag':
                ...
                $this->aCurrent['title'] = _t('_modzzz_formations_page_title_browse_by_tag') . ' ' . $sValue;
                break;

            case 'seeking':
 
  				$this->aCurrent['restriction']['posttype'] =  array('table' => 'modzzz_formations_main', 'value' => 'seeker', 'field' => 'post_type', 'operator' => '=' ); 

                $this->sBrowseUrl = "browse/seeking";
                $this->aCurrent['title'] = _t('_modzzz_formations_page_title_browse_seeking');
                break;
            ...
            case 'recent':
  				$this->aCurrent['restriction']['posttype'] =  array('table' => 'modzzz_formations_main', 'value' => 'provider', 'field' => 'post_type', 'operator' => '=' ); 
                $this->sBrowseUrl = 'browse/recent';
                $this->aCurrent['title'] = _t('_modzzz_formations_page_title_browse_recent');
                break;
            ...
            case 'top':
                ...
                $this->aCurrent['title'] = _t('_modzzz_formations_page_title_browse_top_rated');
                break;
            ...
            case 'popular':
                ...
                $this->aCurrent['title'] = _t('_modzzz_formations_page_title_browse_popular');
                break;                
 
            case 'today':
 
				$this->aCurrent['restriction']['featured'] = array('value' => 1, 'field' => 'today_formation', 'operator' => '=');
		  ...
		  case 'favorite':
				...
				$this->aCurrent['join']['favorites'] = array(
					'type' => 'left',
					'table' => 'modzzz_formations_favorites',
					'mainField' => 'id',
					'onField' => 'id_entry',
					'joinFields' => '',
				);	        
				...
				$this->aCurrent['restriction']['favorite'] = array('value' => $iProfileId, 'field' => 'id_profile', 'operator' => '=', 'table' => 'modzzz_formations_favorites');
                $this->sBrowseUrl = 'browse/favorite';
                $this->aCurrent['title'] = _t('_modzzz_formations_page_title_browse_favorite');
                break;
		 ...
		 case 'application':
                ...
                $this->aCurrent['title'] = _t('_modzzz_formations_page_title_browse_application');
                break;
		...
		////////////////////////
            ...
            case 'featured':
                ...
                $this->aCurrent['title'] = _t('_modzzz_formations_page_title_browse_featured');
            ...
            case 'featured_wanted':
                ...
                $this->aCurrent['title'] = _t('_modzzz_formations_page_title_browse_featured_wanted');
				$this->aCurrent['sorting'] = 'rand';
				break;    
            ...
            case 'calendar':
                ...
                $this->aCurrent['title'] = _t('_modzzz_formations_page_title_browse_by_day') . sprintf("%04u-%02u-%02u", $sValue, $sValue2, $sValue3);
                break;                                
             ...
             case 'companies':  
                ...
                $this->aCurrent['title'] = _t('_modzzz_formations_company_page_title_browse');
			    $this->aCurrent['table'] = 'modzzz_formations_companies'; 
				$this->aCurrent['ownFields'] = array('id','company_name','company_uri','company_desc','company_tags','company_address','company_country','company_city','company_state','company_zip','company_website','company_email','company_telephone','company_fax','company_author_id','company_icon','formation_count','rate','status','created'); 
				$this->aCurrent['searchFields'] = array('company_name', 'company_desc', 'company_tags');
                $this->aCurrent['restriction']['activeStatus'] = array('value' => 'approved', 'field' => 'status', 'operator' => '=');
            ...
            case '':
                ...
                $this->aCurrent['title'] = _t('_modzzz_formations');
                break;
        ...
        $this->aCurrent['paginate']['perPage'] = $oMain->_oDb->getParam('modzzz_formations_perpage_browse');
		...
		if(in_array($sMode, array('companies','company_featured'))){
			...
			if (bx_get('rss')) { 
				$this->aCurrent['paginate']['perPage'] = $oMain->_oDb->getParam('modzzz_formations_max_rss_num');
			}			
			
			bx_import('CompanyVoting', $oMain->_aModule);
			$oVotingView = new BxFormationsCompanyVoting ('modzzz_formations_company', 0);
			...
			$oVotingView = new BxFormationsVoting ('modzzz_formations', 0);
			$this->oVotingView = $oVotingView->isEnabled() ? $oVotingView : null;
		}
    ...
    function getAlterOrder() {
		if ($this->aCurrent['sorting'] == 'last') {
			...
			$aSql = array();
			$aSql['order'] = " ORDER BY `".$this->aCurrent['table']."`.`rate` DESC, `modzzz_formations_main`.`rate_count` DESC";
			return $aSql;
    ...
    function displayResultBlock () {
		...
		if($this->aCurrent['table'] == 'modzzz_formations_companies'){ 
    ...
    function getMain() {
        return BxDolModule::getInstance('BxFormationsModule');
    }
