       ...
       /* freddy modif
        ...
        function getBlockCode_ComposeMessage()
        {
            ...
            $aLanguageKeys = array (
                'cancel'        => _t( '_Cancel' ),
                'send'          => _t( '_Send' ),
              // Freddy change Nickname to FirtName
				//'send_copy'     => _t( '_Send copy to personal email', isset($aMemberInfo['NickName']) ? $aMemberInfo['NickName'] : null ),
				'send_copy'     => _t( '_Send copy to personal email', isset($aMemberInfo['FirstName']) ? $aMemberInfo['FirstName'] : null ),
			   ...
			   'notify'        => _t( '_Notify by e-mail', isset($aMemberInfo['FirstName']) ? $aMemberInfo['FirstName'] : null ),
            ...
            while( true == ($aRow = mysql_fetch_assoc($rResult)) ) {
                    ...
                    case 'inbox' :
                            ...
                            'inputs' => array(
                                'actions' => array(
                                    ...
                                    array (
                                        ...
                                        'attrs'     => array('onclick' => 'if ( typeof oMailBoxViewMessage != \'undefined\') oMailBoxViewMessage.deleteMessages(' . $aRow['ID'] . ')', 'class' => 'ConnectNetworkAdiinviter'),
                                    ),
                                   /*
								    array (
                                        'type'      => 'button',
                                        'value'     => $aLanguageKeys['spam_message'],
                                        'attrs'     => array('onclick' => 'if ( typeof oMailBoxViewMessage != \'undefined\') oMailBoxViewMessage.spamMessages(\'\', ' . $aRow['Sender'] . ')', 'class' => 'ConnectNetworkAdiinviter'),
                                    ),
									*/
                                    array (
                                        'type'      => 'button',
                                        'value'     => $aLanguageKeys['mark_read'],
                                        'attrs'     => array('onclick' => 'if ( typeof oMailBoxViewMessage != \'undefined\') oMailBoxViewMessage.markMessages(\'read\', ' . $aRow['ID'] . ')', 'class' => 'ConnectNetworkAdiinviter'),
                                    ),
                                    array (
                                        'type'      => 'button',
                                        'value'     => $aLanguageKeys['mark_unread'],
                                        'attrs'     => array('onclick' => 'if ( typeof oMailBoxViewMessage != \'undefined\') oMailBoxViewMessage.markMessages(\'unread\', ' . $aRow['ID'] . ')', 'class' => 'ConnectNetworkAdiinviter'),
                                    )
                                )
                            )
                        );
                        ...
                        if($aRow['Sender'] != $this -> aMailBoxSettings['member_id']){
                            $aForm['inputs']['actions'][0] = array(
                                ...
                                'attrs'     => array('onclick' => 'oMailBoxViewMessage.replyMessage(' . $this -> aMailBoxSettings['messageID'] . ', ' . $aRow['Sender'] . ');', 'class' => 'ConnectNetworkAdiinviter'),
                            );
                        }
                        ...
                        'inputs' => array(
                            'actions' => array(
                                ...
                                1 => array (
                                    ...
                                    'attrs'     => array('onclick' => 'if (typeof oMailBoxViewMessage != \'undefined\') oMailBoxViewMessage.restoreMessages(' . $aRow['ID'] . ');', 'class' => 'ConnectNetworkAdiinviter'),
                                ),
                            )
                        )
                    );
                ...
                $aTemplateKeys = array (
                    ...
                    'message_subject'   => $aRow['Subject'],
                     /*  <!-- freddy commentaire 'member_actions_list'    => $sActionsList,
				   ces boutons crree une confusion auprès des utilisateurs car ils sont représenté par des icones
               Mise en commentaire aussi sur le fichier Templtes/Base/mail_box_view_message.html
			   */
        ...
        {
           // Freddy modif  global $oSysTemplate;
            ...
            foreach($aMessages as $aMessage) {
                $aTmplVars['bx_repeat:messages'][] = array(
					...
					'member_icon' => $oFunctions -> getMemberIcon($aMessage['Sender'], 'left'),
                    ...
                    foreach( $aMessages as $iKey => $aItems ) {
					  ...
					  /* freddy modif
					    $sMemberIcon     = $this -> aMailBoxSettings['mailbox_mode'] != 'outbox'
							...
							*/
							 $sMemberIcon     = $this -> aMailBoxSettings['mailbox_mode'] != 'outbox'
                            ? $oFunctions -> getMemberIcon($aItems['Sender'], 'left')
                            :$oFunctions -> getMemberIcon($aItems['Recipient'], 'left');
                                    ...
                                    'inputs' => array(
                                        'actions' => array(
                                            ...
                                            array (
                                                ...
                                                'attrs'     => array('onclick' => 'if ( typeof oMailBoxMessages != \'undefined\' ) oMailBoxMessages.deleteMessages(\'messages_container\', \'genMessagesRows\')', 'class' => 'ConnectNetworkAdiinviter'),
                                            ),
                                            array (
                                                'type'      => 'button',
                                                'value'     => $aLanguageKeys['spam'],
                                                'attrs'     => array('onclick' => 'if (typeof oMailBoxMessages != \'undefined\') oMailBoxMessages.spamMessages(\'messages_container\')', 'class' => 'ConnectNetworkAdiinviter'),
                                            ),
                                            array (
                                                'type'      => 'button',
                                                'value'     => $aLanguageKeys['mark_read'],
                                                'attrs'     => array('onclick' => 'if ( typeof oMailBoxMessages != \'undefined\' ) oMailBoxMessages.markMessages(\'read\', \'genMessagesRows\')', 'class' => 'ConnectNetworkAdiinviter'),
                                            ),
                                            array (
                                                'type'      => 'button',
                                                'value'     => $aLanguageKeys['mark_unread'],
                                                'attrs'     => array('onclick' => 'if ( typeof oMailBoxMessages != \'undefined\' ) oMailBoxMessages.markMessages(\'unread\', \'genMessagesRows\')', 'class' => 'ConnectNetworkAdiinviter'),
                                            )
                                        )
                                    )
                                );
                                    ...
                                    'inputs' => array(
                                        'actions' => array(
                                            ...
                                            0 => array (
                                                ...
                                                'attrs'     => array('onclick' => 'if ( typeof oMailBoxMessages != \'undefined\' ) oMailBoxMessages.restoreMessages(\'messages_container\', \'genMessagesRows\')', 'class' => 'ConnectNetworkAdiinviter'),
                                            ),
                                            1 => array (
                                                'type'      => 'button',
                                                'value'     => $aLanguageKeys['delete'],
                                                'attrs'     => array('onclick' => 'if ( typeof oMailBoxMessages != \'undefined\' ) oMailBoxMessages.hideDeletedMessages(\'messages_container\', \'genMessagesRows\')', 'class' => 'ConnectNetworkAdiinviter'),
                                            ),
                                        ),
                                    )
                                );
