    ...
    function genInputCheckboxSet(&$aInput)
    {
        ...
        if (isset($aInput['values']) and is_array($aInput['values'])) {
            ...
            // generate complex input using simple standard inputs
			  ...
			  // Freddy modif   generer 2 colones de check box au lieu dune
			  // Begin //
            $iColumnWidth = 240; // Width in pixels of each checkbox column.
            ...
            foreach ($aInput['values'] as $sValue => $sLabel) {
                ...
                // Freddy  Begin + Comment out above line   $sOptions .= ($sNewInput . $sDivider);//
                $iCurrentCount ++;
                if($iCurrentCount >= 2) {
    ...
    function genInputRadioSet(&$aInput)
    {
        ...
        if (isset($aInput['values']) and is_array($aInput['values'])) {
            ...
            // generate complex input using simple standard inputs
			 ...
			 // Freddy modif   generer 2 colones de bouton radio au lieu dune
			  // Begin //
