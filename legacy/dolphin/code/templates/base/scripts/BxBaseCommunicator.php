            ...
            if ( $aRows ) {
                ...
                foreach($aRows AS $iKey => $aItems ) {
                    ...
                    if ( $aItems['member_id'] ) {
						...
						// freddy ajout City, Statut
						// member's nickname ;
                        $sMemberCity  = $aProfileInfo['City'];
						 $sMemberStatus  = $aProfileInfo['abs_plinkin_user_title'];
						 
						 
						 //freddy ajout country
						$sMemberPays =  _t($GLOBALS['aPreValues']['Country'][$aProfileInfo['Country']]['LKey']);
                    ...
                    $aProcessedRows[] = array (
						...
						// freddy ajout city, statut  pays
						 'member_city' => $sMemberCity,
     					 'member_pays' =>  $sMemberPays,
						  				
			'bx_if:member_status' => array( 
								'condition' => $sMemberStatus,
								'content' => array(
             'member_status' =>  $sMemberStatus,
								), 
							),
