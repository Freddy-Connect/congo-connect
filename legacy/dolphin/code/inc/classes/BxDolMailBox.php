                ...
                if ( !$isSimulateSending && $bAllowToSend ) {
                    ...
                    if ( db_res($sQuery ) ) {
                        ...
                        if ( $aComposeSettings['send_copy'] ) {
							 ...
							 // freddy ajout $aExpediteurInfo
							 $aExpediteurInfo      = getProfileInfo($this -> aMailBoxSettings['member_id']);
							
							
                          $aTemplate = $oEmailTemplate -> getTemplate( 't_Message', $iRecipientID ) ;
                          $aPlus = array();
                         
						   // freddy ajout Expediteur
						  $aPlus['Expediteur']    = $aExpediteurInfo['FirstName'];
						  ...
						  // freddy ajout  $aPlus['PosterAvatar'] = get_member_thumbnail($this -> aMailBoxSettings['member_id'], 'none', true);
						  $aPlus['PosterAvatar'] = get_member_thumbnail($this -> aMailBoxSettings['member_id'], 'none', true);
