...
class BxDolCategories extends BxDolTags
{
    ...
    function BxDolCategories ($iPossOwner = 0)
    {
	 ...
	 function getGroupChooserMutshi_Investment ($sType, $iOwnerId = 0, $bForm = false, $sCustomValues = '')
    {
        ...
        return array(
            'type' => 'select_box',
                'name' => 'Categories',
                'caption' => _t('_Categories_secteur'),
				 'info' => _t('_sys_info_categories_secteur'),
                ...
                'checker' => array (
                    'func' => 'avail',
                    'error' => _t ('_sys_err_categories_secteur'),
                ),
                'db' => array (
                    'pass' => 'Categories',
                ),
