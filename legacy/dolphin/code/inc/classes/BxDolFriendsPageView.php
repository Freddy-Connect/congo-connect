        ...
        foreach ($aAllFriends as $iFriendID => $aFriendsPrm) {
           ...
           /* FREDDY modif
		     $sHeadline = ( mb_strlen($aMemberInfo['UserStatusMessage']) > 40 )
				...
				*/
				  $sHeadline = ( mb_strlen($aMemberInfo['abs_plinkin_user_title']) > 30 )
                ? mb_substr($aMemberInfo['abs_plinkin_user_title'], 0, 30) . '...'
                : $aMemberInfo['abs_plinkin_user_title'];

            $aFriends[] = array(
                'profile_link' => getProfileLink($iFriendID),
                //Freddy modif     'profile_nick' => $aMemberInfo['NickName'],
				'profile_nick' => $aMemberInfo['FirstName'].' '.$aMemberInfo['LastName'],
