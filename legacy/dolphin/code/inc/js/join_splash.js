...
function doShowError( eForm, sField, iInd, sError ) {
    ...
    $Field.parents('div:first').parents('div:first').addClass( 'error' );
    
    $Field.parents('div:first').parents('div:first').children( '.warnPic' ).children( '.warn' ).attr('float_info', sError);
	$Field.parents('div:first').parents('div:first').children( '.warnPic' ).children( '.warn' ).show();
}
